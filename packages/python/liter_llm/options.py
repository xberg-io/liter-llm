...
@dataclass(frozen=True, slots=True)
class ModelInfo:
    """Public, FFI-friendly snapshot of a model's pricing and capability metadata, projected fro."""
...
def _from_native_decoded_data_url(native: Any) -> DecodedDataUrl:
    """Build the public `DecodedDataUrl` dataclass from the native binding object."""
...
def _from_native_model_info(native: Any) -> ModelInfo:
    """Build the public `ModelInfo` dataclass from the native binding object."""
    return ModelInfo(
        ...
        max_output_tokens=native.max_output_tokens,
        mode=native.mode,
        supports_vision=native.supports_vision,
        supports_function_calling=native.supports_function_calling,
        supports_reasoning=native.supports_reasoning,
        supports_structured_output=native.supports_structured_output,
        supports_audio_input=native.supports_audio_input,
        supports_audio_output=native.supports_audio_output,
        supports_prompt_caching=native.supports_prompt_caching,
        tiers=[_from_native_model_tier(__v) for __v in native.tiers],
    )
