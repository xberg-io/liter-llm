...
// alef:hash:13f1c530ffea1e80760a8073596e57ce2066c927c5775a1e03e305908a61f6b9
...
pub fn defaultclient_chat_async(
    ...
    let req_core: Option<liter_llm::ChatCompletionRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::ChatCompletionRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
...
pub fn defaultclient_embed_async(
    ...
    let req_core: Option<liter_llm::EmbeddingRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::EmbeddingRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_image_generate_async(
    ...
    let req_core: Option<liter_llm::CreateImageRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::CreateImageRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_speech_async(
    ...
    let req_core: Option<liter_llm::CreateSpeechRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::CreateSpeechRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_transcribe_async(
    ...
    let req_core: Option<liter_llm::CreateTranscriptionRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::CreateTranscriptionRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_moderate_async(
    ...
    let req_core: Option<liter_llm::ModerationRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::ModerationRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_rerank_async(
    ...
    let req_core: Option<liter_llm::RerankRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::RerankRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_search_async(
    ...
    let req_core: Option<liter_llm::SearchRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::SearchRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_ocr_async(
    ...
    let req_core: Option<liter_llm::OcrRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::OcrRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_create_file_async(
    ...
    let req_core: Option<liter_llm::CreateFileRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::CreateFileRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_list_files_async(
    ...
    let query_core: Option<liter_llm::FileListQuery> = query
        .map(|s| serde_json::from_str::<liter_llm::FileListQuery>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_create_batch_async(
    ...
    let req_core: Option<liter_llm::CreateBatchRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::CreateBatchRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_list_batches_async(
    ...
    let query_core: Option<liter_llm::BatchListQuery> = query
        .map(|s| serde_json::from_str::<liter_llm::BatchListQuery>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
pub fn defaultclient_create_response_async(
    ...
    let req_core: Option<liter_llm::CreateResponseRequest> = req
        .map(|s| serde_json::from_str::<liter_llm::CreateResponseRequest>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    std::thread::Builder::new()
        .stack_size(32 * 1024 * 1024)
...
impl From<AuthHeaderFormat> for liter_llm::AuthHeaderFormat {
    fn from(val: AuthHeaderFormat) -> Self {
        match val.format_type.as_str() {
            "Bearer" => liter_llm::AuthHeaderFormat::Bearer,
            "ApiKey" => liter_llm::AuthHeaderFormat::ApiKey(val.api_key.unwrap_or_default().into()),
