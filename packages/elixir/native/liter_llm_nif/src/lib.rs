...
// alef:hash:f371c02cec3a66fa9f71da169bba1780bbc0647c37e1885aa9e985e5be320129
...
pub fn defaultclient_chat_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            let result = rt
                .block_on(async { resource.inner.chat(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_embed_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.embed(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_image_generate_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.image_generate(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_speech_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.speech(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.to_vec())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_transcribe_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.transcribe(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_moderate_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.moderate(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_rerank_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.rerank(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_search_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.search(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_ocr_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.ocr(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_create_file_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.create_file(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_list_files_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.list_files(query_core).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_create_batch_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.create_batch(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_list_batches_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.list_batches(query_core).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
...
pub fn defaultclient_create_response_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
            let result = rt
                .block_on(async { resource.inner.create_response(req_core.unwrap_or_default()).await })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
        })
        .map_err(|e| e.to_string())?
