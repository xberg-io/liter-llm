...
// alef:hash:892b0a35829667973c67df038348e84bca6488b0ed066a8bc5b87f294ce0290a
...
impl From<liter_llm::Message> for Message {
    fn from(val: liter_llm::Message) -> Self {
        match val {
            liter_llm::Message::System(_0) => Self {
                role: "system".to_string(),
                system: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::Message::User(_0) => Self {
                role: "user".to_string(),
                user: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::Message::Assistant(_0) => Self {
                role: "assistant".to_string(),
                assistant: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::Message::Tool(_0) => Self {
                role: "tool".to_string(),
                tool: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::Message::Developer(_0) => Self {
                role: "developer".to_string(),
                developer: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::Message::Function(_0) => Self {
...
impl From<Message> for liter_llm::Message {
    fn from(val: Message) -> Self {
        match val.role.as_str() {
            "system" => liter_llm::Message::System(val.system.unwrap_or_default().into()),
            "user" => liter_llm::Message::User(val.user.unwrap_or_default().into()),
            "assistant" => liter_llm::Message::Assistant(val.assistant.unwrap_or_default().into()),
            "tool" => liter_llm::Message::Tool(val.tool.unwrap_or_default().into()),
            "developer" => liter_llm::Message::Developer(val.developer.unwrap_or_default().into()),
            "function" => liter_llm::Message::Function(val.function.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}

impl From<liter_llm::UserContent> for UserContent {
    fn from(val: liter_llm::UserContent) -> Self {
        match val {
            liter_llm::UserContent::Text(_0) => Self {
                format_type: "Text".to_string(),
                text: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::UserContent::Parts(_0) => Self {
...
impl From<UserContent> for liter_llm::UserContent {
    fn from(val: UserContent) -> Self {
        match val.format_type.as_str() {
            "Text" => liter_llm::UserContent::Text(val.text.unwrap_or_default().into()),
            "Parts" => {
                liter_llm::UserContent::Parts(val.parts.unwrap_or_default().into_iter().map(Into::into).collect())
            }
            _ => Default::default(),
        }
    }
...
impl From<liter_llm::ToolChoice> for ToolChoice {
    fn from(val: liter_llm::ToolChoice) -> Self {
        match val {
            liter_llm::ToolChoice::Mode(_0) => Self {
                format_type: "Mode".to_string(),
                mode: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::ToolChoice::Specific(_0) => Self {
...
impl From<ToolChoice> for liter_llm::ToolChoice {
    fn from(val: ToolChoice) -> Self {
        match val.format_type.as_str() {
            "Mode" => liter_llm::ToolChoice::Mode(val.mode.unwrap_or_default().into()),
            "Specific" => liter_llm::ToolChoice::Specific(val.specific.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
...
impl From<liter_llm::StopSequence> for StopSequence {
    fn from(val: liter_llm::StopSequence) -> Self {
        match val {
            liter_llm::StopSequence::Single(_0) => Self {
                format_type: "Single".to_string(),
                single: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::StopSequence::Multiple(_0) => Self {
...
impl From<StopSequence> for liter_llm::StopSequence {
    fn from(val: StopSequence) -> Self {
        match val.format_type.as_str() {
            "Single" => liter_llm::StopSequence::Single(val.single.unwrap_or_default().into()),
            "Multiple" => liter_llm::StopSequence::Multiple(val.multiple.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
...
impl From<liter_llm::EmbeddingInput> for EmbeddingInput {
    fn from(val: liter_llm::EmbeddingInput) -> Self {
        match val {
            liter_llm::EmbeddingInput::Single(_0) => Self {
                format_type: "Single".to_string(),
                single: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::EmbeddingInput::Multiple(_0) => Self {
                format_type: "Multiple".to_string(),
                multiple: Some(_0.into()),
                ..Default::default()
            },
...
impl From<EmbeddingInput> for liter_llm::EmbeddingInput {
    fn from(val: EmbeddingInput) -> Self {
        match val.format_type.as_str() {
            "Single" => liter_llm::EmbeddingInput::Single(val.single.unwrap_or_default().into()),
            "Multiple" => liter_llm::EmbeddingInput::Multiple(val.multiple.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
...
impl From<liter_llm::ModerationInput> for ModerationInput {
    fn from(val: liter_llm::ModerationInput) -> Self {
        match val {
            liter_llm::ModerationInput::Single(_0) => Self {
                format_type: "Single".to_string(),
                single: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::ModerationInput::Multiple(_0) => Self {
                format_type: "Multiple".to_string(),
                multiple: Some(_0.into()),
                ..Default::default()
            },
...
impl From<ModerationInput> for liter_llm::ModerationInput {
    fn from(val: ModerationInput) -> Self {
        match val.format_type.as_str() {
            "Single" => liter_llm::ModerationInput::Single(val.single.unwrap_or_default().into()),
            "Multiple" => liter_llm::ModerationInput::Multiple(val.multiple.unwrap_or_default().into()),
            _ => Default::default(),
        }
    }
}
...
impl From<liter_llm::AuthHeaderFormat> for AuthHeaderFormat {
    fn from(val: liter_llm::AuthHeaderFormat) -> Self {
        match val {
            liter_llm::AuthHeaderFormat::Bearer => Self {
                format_type: "Bearer".to_string(),
                ..Default::default()
            },
            liter_llm::AuthHeaderFormat::ApiKey(_0) => Self {
                format_type: "ApiKey".to_string(),
                api_key: Some(_0.into()),
                ..Default::default()
            },
            liter_llm::AuthHeaderFormat::None => Self {
