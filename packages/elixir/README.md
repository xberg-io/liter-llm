...
Universal LLM API client for Elixir. Access 163 LLM providers through a single interface with native BEAM concurrency, OTP integration, and idiomatic Elixir API.
