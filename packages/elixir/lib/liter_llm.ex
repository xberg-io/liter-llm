...
# alef:hash:7b1c178a780a949cf1a7fe6b18f1ac758a406d12d1fc728839885135f545d21d
...
defmodule LiterLlm do
  ...
  @spec count_request_tokens(String.t(), keyword()) ::
          {:ok, non_neg_integer()} | {:error, atom, String.t()}
  def count_request_tokens(model, opts \\ []) do
