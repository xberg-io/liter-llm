...
object LiterLlmConverter {
     ...
     */
    fun createClient(apiKey: String, baseUrl: String? = null, timeoutSecs: Long? = null, maxRetries: Int? = null, modelHint: String? = null): DefaultClient = DefaultClient(LiterLlmConverterBridge.nativeCreateClient(apiKey, baseUrl ?: "", timeoutSecs ?: 0L, maxRetries ?: 0, modelHint ?: ""))
    /**
     ...
     */
    fun createClientFromJson(json: String): DefaultClient = DefaultClient(LiterLlmConverterBridge.nativeCreateClientFromJson(json))
    /**
     ...
     * no model prefixes).
     */
    fun registerCustomProvider(config: CustomProviderConfig): Unit = LiterLlmConverterBridge.nativeRegisterCustomProvider(mapper.writeValueAsString(config))
    /**
     ...
     */
    fun unregisterCustomProvider(name: String): Boolean = LiterLlmConverterBridge.nativeUnregisterCustomProvider(name)
    /**
    ...
    fun allProviders(): List<ProviderConfig> {
        val resultJson = LiterLlmConverterBridge.nativeAllProviders()
    ...
    fun complexProviderNames(): List<String> {
        val resultJson = LiterLlmConverterBridge.nativeComplexProviderNames()
     ...
     */
    fun completionCost(model: String, promptTokens: Long, completionTokens: Long): String? = LiterLlmConverterBridge.nativeCompletionCost(model, promptTokens, completionTokens)
    /**
     ...
     */
    fun completionCostWithCache(model: String, promptTokens: Long, cachedTokens: Long, completionTokens: Long): String? = LiterLlmConverterBridge.nativeCompletionCostWithCache(model, promptTokens, cachedTokens, completionTokens)
    /**
     ...
     */
    fun ensureCryptoProvider(): Unit = LiterLlmConverterBridge.nativeEnsureCryptoProvider()
}
