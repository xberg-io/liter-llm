...
object LiterLlmConverter {
    ...
    fun createClient(
        ...
        DefaultClient(
            LiterLlmConverterBridge.nativeCreateClient(
                apiKey,
                baseUrl ?: "",
                timeoutSecs ?: 0L,
                maxRetries ?: 0,
    ...
    fun createClientFromJson(json: String): DefaultClient =
        DefaultClient(LiterLlmConverterBridge.nativeCreateClientFromJson(json))
    ...
    fun registerCustomProvider(config: CustomProviderConfig): Unit =
        LiterLlmConverterBridge.nativeRegisterCustomProvider(mapper.writeValueAsString(config))
    ...
    fun unregisterCustomProvider(name: String): Boolean =
        LiterLlmConverterBridge.nativeUnregisterCustomProvider(name)
    ...
    ): String? = LiterLlmConverterBridge.nativeCompletionCost(model, promptTokens, completionTokens)
    ...
    fun completionCostWithCache(
        ...
        LiterLlmConverterBridge.nativeCompletionCostWithCache(
            model,
            promptTokens,
            cachedTokens,
            completionTokens,
