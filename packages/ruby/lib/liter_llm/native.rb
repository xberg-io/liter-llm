...
# alef:hash:b7c4de5691d3aafa05a6b1c93b0eb5ecff5e6f85abf8d17b45f8e97b3d2a6e94
...
module LiterLlm
  ...
  MessageSystem = Data.define(_0) do
    include Message
    extend T::Sig
  ...
  MessageAssistant = Data.define(_0) do
    include Message
    extend T::Sig
  ...
  MessageDeveloper = Data.define(_0) do
    include Message
    extend T::Sig
  ...
  MessageFunction = Data.define(_0) do
    include Message
    extend T::Sig
