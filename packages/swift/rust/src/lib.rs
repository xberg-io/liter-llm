...
impl WaitForBatchConfig {
    ...
    pub fn initial_interval_secs(&self) -> f64 {
        self.0.initial_interval_secs.clone()
    }
    pub fn max_interval_secs(&self) -> f64 {
        self.0.max_interval_secs.clone()
    }
    pub fn backoff_multiplier(&self) -> f32 {
        self.0.backoff_multiplier.clone()
    }
...
pub fn default_client_retrieve(client: &DefaultClient, batch_id: String) -> Result<BatchObject, String> {
    crate::__alef_tokio_runtime().block_on(async {
        client
            .0
            .retrieve(&batch_id)
