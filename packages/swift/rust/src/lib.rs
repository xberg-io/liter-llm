...
impl AssistantMessage {
    pub fn new(
        ...
        if let Some(s) = reasoning_content {
            ...
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.reasoning_content = Some(t);
            }
        }
    ...
    pub fn tool_calls(&self) -> String {
        serde_json::to_string(&self.0.tool_calls).expect("serializable optional vec")
    }
...
impl ChatCompletionRequest {
    ...
    pub fn modalities(&self) -> String {
        serde_json::to_string(&self.0.modalities).expect("serializable optional vec")
    }
...
impl TranscriptionResponse {
    ...
    pub fn segments(&self) -> String {
        serde_json::to_string(&self.0.segments).expect("serializable optional vec")
    }
}
...
impl OcrPage {
    ...
    pub fn images(&self) -> String {
        serde_json::to_string(&self.0.images).expect("serializable optional vec")
    }
