...
// alef:hash:41de9d34263d5d6dbc26608c2fa561e7d6bbe639f51f257869bdc6bf96c19551
...
final class DefaultClient
{
    ...
    {
        $handle = \defaultclient_chat_stream_start($this, $req);
        try {
            while (($chunk = \defaultclient_chat_stream_next($handle)) !== null) {
                yield json_decode($chunk, true);
            }
        } finally {
            \defaultclient_chat_stream_free($handle);
        }
    }
