...
// alef:hash:f0ec47781ee9740c6fb7ea7b1847129fb25a5a1948426193196828d457e24803
...
final class DefaultClient
{
    ...
    public function chatStream(): \Generator
    {
        $handle = \defaultclient_chat_stream_start($this);
        try {
