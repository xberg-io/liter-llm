...
final class NativeLib {
  ...
  static final MethodHandle LITERLLM_CREATE_CLIENT = LINKER.downcallHandle(
      LIB.find("literllm_create_client")
          ...
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_create_client (tried: literllm_create_client,"
                  + " _literllm_create_client). Ensure the native library was compiled with"
  ...
  static final MethodHandle LITERLLM_CREATE_CLIENT_FROM_JSON = LINKER.downcallHandle(
      LIB.find("literllm_create_client_from_json")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_create_client_from_json (tried:"
                  + " literllm_create_client_from_json, _literllm_create_client_from_json)."
                  + " Ensure the native library was compiled with this function exported. If"
                  + " this is an optional feature, check that all required features are"
                  + " enabled.")),
  ...
  static final MethodHandle LITERLLM_ENCODE_DATA_URL = LINKER.downcallHandle(
      LIB.find("literllm_encode_data_url")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_encode_data_url (tried:"
                  + " literllm_encode_data_url, _literllm_encode_data_url). Ensure the native"
  ...
  static final MethodHandle LITERLLM_DECODE_DATA_URL = LINKER.downcallHandle(
      LIB.find("literllm_decode_data_url")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_decode_data_url (tried:"
                  + " literllm_decode_data_url, _literllm_decode_data_url). Ensure the native"
                  + " library was compiled with this function exported. If this is an optional"
                  + " feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_REGISTER_CUSTOM_PROVIDER = LINKER.downcallHandle(
      LIB.find("literllm_register_custom_provider")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_register_custom_provider (tried:"
                  + " literllm_register_custom_provider, _literllm_register_custom_provider)."
                  + " Ensure the native library was compiled with this function exported. If"
                  + " this is an optional feature, check that all required features are"
                  + " enabled.")),
  ...
  static final MethodHandle LITERLLM_UNREGISTER_CUSTOM_PROVIDER = LINKER.downcallHandle(
      LIB.find("literllm_unregister_custom_provider")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_unregister_custom_provider (tried:"
                  + " literllm_unregister_custom_provider,"
                  + " _literllm_unregister_custom_provider). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
  ...
  static final MethodHandle LITERLLM_CAPABILITIES = LINKER.downcallHandle(
      LIB.find("literllm_capabilities")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_capabilities (tried: literllm_capabilities,"
                  + " _literllm_capabilities). Ensure the native library was compiled with"
                  + " this function exported. If this is an optional feature, check that all"
                  + " required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_ALL_PROVIDERS = LINKER.downcallHandle(
      LIB.find("literllm_all_providers")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_all_providers (tried: literllm_all_providers,"
                  + " _literllm_all_providers). Ensure the native library was compiled with"
                  + " this function exported. If this is an optional feature, check that all"
                  + " required features are enabled.")),
  ...
  static final MethodHandle LITERLLM_COMPLEX_PROVIDER_NAMES = LINKER.downcallHandle(
      LIB.find("literllm_complex_provider_names")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_complex_provider_names (tried:"
                  + " literllm_complex_provider_names, _literllm_complex_provider_names)."
                  + " Ensure the native library was compiled with this function exported. If"
                  + " this is an optional feature, check that all required features are"
                  + " enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_COMPLETION_COST = LINKER.downcallHandle(
      LIB.find("literllm_completion_cost")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_completion_cost (tried:"
                  + " literllm_completion_cost, _literllm_completion_cost). Ensure the native"
                  + " library was compiled with this function exported. If this is an optional"
                  + " feature, check that all required features are enabled.")),
      FunctionDescriptor.of(
  ...
  static final MethodHandle LITERLLM_COMPLETION_COST_WITH_CACHE = LINKER.downcallHandle(
      LIB.find("literllm_completion_cost_with_cache")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_completion_cost_with_cache (tried:"
                  + " literllm_completion_cost_with_cache,"
                  + " _literllm_completion_cost_with_cache). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(
          ValueLayout.JAVA_DOUBLE,
  ...
  static final MethodHandle LITERLLM_CLEAR = LINKER.downcallHandle(
      LIB.find("literllm_clear")
          ...
          .orElseThrow(() -> new ExceptionInInitializerError("Native symbol not found: "
              + "literllm_clear" + " (tried: literllm_clear, _literllm_clear). "
  ...
  static final MethodHandle LITERLLM_COUNT_TOKENS = LINKER.downcallHandle(
      LIB.find("literllm_count_tokens")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_count_tokens (tried: literllm_count_tokens,"
                  + " _literllm_count_tokens). Ensure the native library was compiled with"
                  + " this function exported. If this is an optional feature, check that all"
                  + " required features are enabled.")),
  ...
  static final MethodHandle LITERLLM_COUNT_REQUEST_TOKENS = LINKER.downcallHandle(
      LIB.find("literllm_count_request_tokens")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_count_request_tokens (tried:"
                  + " literllm_count_request_tokens, _literllm_count_request_tokens). Ensure"
  ...
  static final MethodHandle LITERLLM_CHECK_BOUND = LINKER.downcallHandle(
      LIB.find("literllm_check_bound")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError("Native symbol not found: "
              + "literllm_check_bound" + " (tried: literllm_check_bound, _literllm_check_bound). "
              + "Ensure the native library was compiled with this function exported. "
              + "If this is an optional feature, check that all required features are enabled.")),
      FunctionDescriptor.ofVoid(
          ValueLayout.ADDRESS,
  ...
  static final MethodHandle LITERLLM_ENSURE_CRYPTO_PROVIDER = LINKER.downcallHandle(
      LIB.find("literllm_ensure_crypto_provider")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_ensure_crypto_provider (tried:"
                  + " literllm_ensure_crypto_provider, _literllm_ensure_crypto_provider)."
                  + " Ensure the native library was compiled with this function exported. If"
                  + " this is an optional feature, check that all required features are"
                  + " enabled.")),
      FunctionDescriptor.ofVoid());
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CHAT = LINKER.downcallHandle(
      LIB.find("literllm_default_client_chat")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_chat (tried:"
                  + " literllm_default_client_chat, _literllm_default_client_chat). Ensure the"
                  + " native library was compiled with this function exported. If this is an"
                  + " optional feature, check that all required features are enabled.")),
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_EMBED = LINKER.downcallHandle(
      LIB.find("literllm_default_client_embed")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_embed (tried:"
                  + " literllm_default_client_embed, _literllm_default_client_embed). Ensure"
                  + " the native library was compiled with this function exported. If this is"
                  + " an optional feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_LIST_MODELS = LINKER.downcallHandle(
      LIB.find("literllm_default_client_list_models")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_list_models (tried:"
                  + " literllm_default_client_list_models,"
                  + " _literllm_default_client_list_models). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_IMAGE_GENERATE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_image_generate")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_image_generate (tried:"
                  + " literllm_default_client_image_generate,"
                  + " _literllm_default_client_image_generate). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_SPEECH = LINKER.downcallHandle(
      LIB.find("literllm_default_client_speech")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_speech (tried:"
                  + " literllm_default_client_speech, _literllm_default_client_speech). Ensure"
                  + " the native library was compiled with this function exported. If this is"
                  + " an optional feature, check that all required features are enabled.")),
      FunctionDescriptor.of(
          ValueLayout.JAVA_INT,
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_TRANSCRIBE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_transcribe")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_transcribe (tried:"
                  + " literllm_default_client_transcribe,"
                  + " _literllm_default_client_transcribe). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_MODERATE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_moderate")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_moderate (tried:"
                  + " literllm_default_client_moderate, _literllm_default_client_moderate)."
                  + " Ensure the native library was compiled with this function exported. If"
                  + " this is an optional feature, check that all required features are"
                  + " enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_RERANK = LINKER.downcallHandle(
      LIB.find("literllm_default_client_rerank")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_rerank (tried:"
                  + " literllm_default_client_rerank, _literllm_default_client_rerank). Ensure"
                  + " the native library was compiled with this function exported. If this is"
                  + " an optional feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_SEARCH = LINKER.downcallHandle(
      LIB.find("literllm_default_client_search")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_search (tried:"
                  + " literllm_default_client_search, _literllm_default_client_search). Ensure"
                  + " the native library was compiled with this function exported. If this is"
                  + " an optional feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_OCR = LINKER.downcallHandle(
      LIB.find("literllm_default_client_ocr")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_ocr (tried:"
                  + " literllm_default_client_ocr, _literllm_default_client_ocr). Ensure the"
                  + " native library was compiled with this function exported. If this is an"
                  + " optional feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CREATE_FILE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_create_file")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_create_file (tried:"
                  + " literllm_default_client_create_file,"
                  + " _literllm_default_client_create_file). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_RETRIEVE_FILE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_retrieve_file")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_retrieve_file (tried:"
                  + " literllm_default_client_retrieve_file,"
                  + " _literllm_default_client_retrieve_file). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_DELETE_FILE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_delete_file")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_delete_file (tried:"
                  + " literllm_default_client_delete_file,"
                  + " _literllm_default_client_delete_file). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_LIST_FILES = LINKER.downcallHandle(
      LIB.find("literllm_default_client_list_files")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_list_files (tried:"
                  + " literllm_default_client_list_files,"
                  + " _literllm_default_client_list_files). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_FILE_CONTENT = LINKER.downcallHandle(
      LIB.find("literllm_default_client_file_content")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_file_content (tried:"
                  + " literllm_default_client_file_content,"
                  + " _literllm_default_client_file_content). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(
          ValueLayout.JAVA_INT,
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CREATE_BATCH = LINKER.downcallHandle(
      LIB.find("literllm_default_client_create_batch")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_create_batch (tried:"
                  + " literllm_default_client_create_batch,"
                  + " _literllm_default_client_create_batch). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_RETRIEVE_BATCH = LINKER.downcallHandle(
      LIB.find("literllm_default_client_retrieve_batch")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_retrieve_batch (tried:"
                  + " literllm_default_client_retrieve_batch,"
                  + " _literllm_default_client_retrieve_batch). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_LIST_BATCHES = LINKER.downcallHandle(
      LIB.find("literllm_default_client_list_batches")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_list_batches (tried:"
                  + " literllm_default_client_list_batches,"
                  + " _literllm_default_client_list_batches). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CANCEL_BATCH = LINKER.downcallHandle(
      LIB.find("literllm_default_client_cancel_batch")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_cancel_batch (tried:"
                  + " literllm_default_client_cancel_batch,"
                  + " _literllm_default_client_cancel_batch). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
      ...
      LIB.find("literllm_default_client_fetch_batch_for_polling")
          ...
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_fetch_batch_for_polling"
                  + " (tried: literllm_default_client_fetch_batch_for_polling,"
                  + " _literllm_default_client_fetch_batch_for_polling). Ensure the native"
                  + " library was compiled with this function exported. If this is an optional"
                  + " feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_WAIT_FOR_BATCH = LINKER.downcallHandle(
      LIB.find("literllm_default_client_wait_for_batch")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_wait_for_batch (tried:"
                  + " literllm_default_client_wait_for_batch,"
                  + " _literllm_default_client_wait_for_batch). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CREATE_RESPONSE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_create_response")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_create_response (tried:"
                  + " literllm_default_client_create_response,"
                  + " _literllm_default_client_create_response). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_RETRIEVE_RESPONSE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_retrieve_response")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_retrieve_response (tried:"
                  + " literllm_default_client_retrieve_response,"
                  + " _literllm_default_client_retrieve_response). Ensure the native library"
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CANCEL_RESPONSE = LINKER.downcallHandle(
      LIB.find("literllm_default_client_cancel_response")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_cancel_response (tried:"
                  + " literllm_default_client_cancel_response,"
                  + " _literllm_default_client_cancel_response). Ensure the native library was"
                  + " compiled with this function exported. If this is an optional feature,"
                  + " check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DECODED_DATA_URL_TO_JSON = LIB.find(
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CHAT_STREAM_START = LINKER.downcallHandle(
      LIB.find("literllm_default_client_chat_stream_start")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_chat_stream_start (tried:"
                  + " literllm_default_client_chat_stream_start,"
                  + " _literllm_default_client_chat_stream_start). Ensure the native library"
                  + " was compiled with this function exported. If this is an optional"
                  + " feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
  ...
  static final MethodHandle LITERLLM_DEFAULT_CLIENT_CHAT_STREAM_NEXT = LINKER.downcallHandle(
      LIB.find("literllm_default_client_chat_stream_next")
          ...
          // Fallback underscore variant
          .orElseThrow(() -> new ExceptionInInitializerError(
              "Native symbol not found: literllm_default_client_chat_stream_next (tried:"
                  + " literllm_default_client_chat_stream_next,"
                  + " _literllm_default_client_chat_stream_next). Ensure the native library"
                  + " was compiled with this function exported. If this is an optional"
                  + " feature, check that all required features are enabled.")),
      FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
