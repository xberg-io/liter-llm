...
// alef:hash:9a773a3f69c345ec06549fedcb549cf593acc3819a56ad80503bbcbef59131bd
...
final class NativeLib {
    ...
    static final MethodHandle LITERLLM_COMPLETION_COST_WITH_CACHE = LINKER.downcallHandle(
        LIB.find("literllm_completion_cost_with_cache").orElseThrow(),
        FunctionDescriptor.of(
    ...
    static final MethodHandle LITERLLM_TOWER_CACHED_RESPONSE_INTO_LLM_RESPONSE = LINKER.downcallHandle(
        LIB.find("literllm_tower_cached_response_into_llm_response").orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_LLM_REQUEST_OPERATION_NAME = LINKER.downcallHandle(
        LIB.find("literllm_tower_llm_request_operation_name").orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_LLM_REQUEST_REQUEST_TYPE = LINKER.downcallHandle(
        LIB.find("literllm_tower_llm_request_request_type").orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_LLM_REQUEST_MODEL = LINKER.downcallHandle(
        LIB.find("literllm_tower_llm_request_model").orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_LLM_RESPONSE_USAGE = LINKER.downcallHandle(
        LIB.find("literllm_tower_llm_response_usage").orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)
    );
    ...
    static final MethodHandle LITERLLM_USAGE_TO_JSON = LIB.find("literllm_usage_to_json")
        .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS)))
        .orElse(null);


    static final MethodHandle LITERLLM_USAGE_FREE = LINKER.downcallHandle(
        LIB.find("literllm_usage_free").orElseThrow(),
        FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_CACHED_RESPONSE_FREE = LINKER.downcallHandle(
        LIB.find("literllm_tower_cached_response_free").orElseThrow(),
        FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_LLM_REQUEST_FREE = LINKER.downcallHandle(
        LIB.find("literllm_tower_llm_request_free").orElseThrow(),
        FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)
    );


    static final MethodHandle LITERLLM_TOWER_LLM_RESPONSE_FREE = LINKER.downcallHandle(
        LIB.find("literllm_tower_llm_response_free").orElseThrow(),
        FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)
    );
