...
// alef:hash:8771528a60fdae67c81c34052b158e3f1b31c26fedd71f6303d8a5901976d51d
...
public final class LiterLlm {
     ...
     * first load.
     * {@literal @}throws KreuzbergRsException Returns LiterLlmError.BadRequest if the tokenizer cannot be loaded
     ...
     * {@literal @}throws KreuzbergRsException Returns LiterLlmError.BadRequest if the tokenizer cannot be loaded or
    ...
    public static java.util.Iterator<ChatCompletionChunk> chatStream(ChatCompletionRequest req) throws LiterLlmRsException {
        return LiterLlmRs.chatStream(req);
    }
}
