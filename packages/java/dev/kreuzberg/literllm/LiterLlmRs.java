...
// alef:hash:4cd975e502b4d03e60fc135e9c4d70e5a228538c4518f1916f46e631689fee66
...
public final class LiterLlmRs {
    ...
    public static DefaultClient createClient(final String apiKey, final String baseUrl, final Long timeoutSecs, final Integer maxRetries, final String modelHint) throws LiterLlmRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            long ctimeoutSecs = (timeoutSecs == null) ? 0L : timeoutSecs;
            int cmaxRetries = (maxRetries == null) ? 0 : maxRetries;
