...
public final class LiterLlm {
   ...
   */
  public static @Nullable DecodedDataUrl decodeDataUrl(final String url)
      throws LiterLlmRsException {
  ...
  public static @Nullable Double completionCostWithCache(
    ...
    java.util.Objects.requireNonNull(completionTokens, "completionTokens must not be null");
    return LiterLlmRs.completionCostWithCache(model, promptTokens, cachedTokens, completionTokens)
        .orElse(null);
  }
  ...
  public static java.util.stream.Stream<ChatCompletionChunk> chatStream(
      final DefaultClient engine, final ChatCompletionRequest req) throws LiterLlmRsException {
