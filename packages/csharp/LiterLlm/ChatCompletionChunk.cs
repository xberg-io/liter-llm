...
// alef:hash:157ad89a2b339fb9e0e4d8a925f55d5e40791bec63f4ea7668b61df58880388f
    ...
    public static ChatCompletionChunk FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<ChatCompletionChunk>(json, JsonOptions)
                ?? throw new liter- llmException($"Failed to parse ChatCompletionChunk from JSON: deserializer returned null");
        }
        ...
        {
            throw new liter- llmException($"Failed to parse ChatCompletionChunk from JSON: {e.Message}", e);
        }
    }
