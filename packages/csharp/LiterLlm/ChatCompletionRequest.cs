...
// alef:hash:1417ab0ed0c40b77405e277226e5820a925ed875cec0f485c8358fcca8089eb5
    ...
    public static ChatCompletionRequest FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<ChatCompletionRequest>(json, JsonOptions)
                ?? throw new liter- llmException($"Failed to parse ChatCompletionRequest from JSON: deserializer returned null");
        }
        ...
        {
            throw new liter- llmException($"Failed to parse ChatCompletionRequest from JSON: {e.Message}", e);
        }
    }
