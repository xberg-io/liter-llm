...
<<<<<<< Updated upstream
        {
            ...
            "open_dal" => JsonSerializer.Deserialize<CacheBackend.OpenDal>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),            // Unknown discriminator: forward compatibility for unknown variants
            _ => throw new JsonException($"Unknown CacheBackend discriminator: {tagValue}")
=======
        {            "memory" => new CacheBackend.Memory(),            "open_dal" => JsonSerializer.Deserialize<CacheBackend.OpenDal>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),            _ => throw new JsonException($"Unknown CacheBackend discriminator: {tagValue}")
>>>>>>> Stashed changes
        };
    }
