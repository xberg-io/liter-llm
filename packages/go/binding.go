...
// alef:hash:9396da299b9a2113a97b71bfdf5827cc8facc5aca9c52d8911c6efca1f1f32ad
...
// StatusCode returns Returns the canonical HTTP status code associated with this error.
...
func (e Error) StatusCode() uint16 { return e.StatusCode }

// IsTransient returns Returns `true` for errors that are worth retrying on a different service
or deployment (transient failures).

Used by `FallbackService` and
`Router` to decide whether to route to an
alternative endpoint..
func (e Error) IsTransient() bool { return e.IsTransient }

// ErrorType returns Return the OpenTelemetry `error.type` string for this error variant.
...
func (e Error) ErrorType() string { return e.ErrorType }
