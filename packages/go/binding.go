...
// alef:hash:8e18c83e7a4fd9b4b2ff6a420d7a063a54479e8285695cc4d8b2a4187417e712
...
// BudgetConfigOption is an option function for BudgetConfig.
type BudgetConfigOption func(*BudgetConfig)

// WithBudgetConfigGlobalLimit sets the global_limit field.
func WithBudgetConfigGlobalLimit(v float64) BudgetConfigOption {
	return func(c *BudgetConfig) { c.GlobalLimit = &v }
}

// WithBudgetConfigModelLimits sets the model_limits field.
func WithBudgetConfigModelLimits(v map[string]float64) BudgetConfigOption {
	return func(c *BudgetConfig) { c.ModelLimits = v }
}

// WithBudgetConfigEnforcement sets the enforcement field.
func WithBudgetConfigEnforcement(v Enforcement) BudgetConfigOption {
	return func(c *BudgetConfig) { c.Enforcement = &v }
}

// NewBudgetConfig creates a BudgetConfig with optional parameters.
func NewBudgetConfig(opts ...BudgetConfigOption) *BudgetConfig {
	c := &BudgetConfig{
		GlobalLimit: nil,
		ModelLimits: nil,
		Enforcement: nil,
...
// CacheConfigOption is an option function for CacheConfig.
type CacheConfigOption func(*CacheConfig)

// WithCacheConfigMaxEntries sets the max_entries field.
func WithCacheConfigMaxEntries(v uint) CacheConfigOption {
	return func(c *CacheConfig) { c.MaxEntries = &v }
}

// WithCacheConfigTTL sets the ttl field.
func WithCacheConfigTTL(v uint64) CacheConfigOption {
	return func(c *CacheConfig) { c.TTL = &v }
}

// WithCacheConfigBackend sets the backend field.
func WithCacheConfigBackend(v CacheBackend) CacheConfigOption {
	return func(c *CacheConfig) { c.Backend = v }
}

// NewCacheConfig creates a CacheConfig with optional parameters.
func NewCacheConfig(opts ...CacheConfigOption) *CacheConfig {
	c := &CacheConfig{
		MaxEntries: nil,
		TTL:        nil,
		Backend:    nil,
...
// TowerCachedResponse is an opaque handle type.
type TowerCachedResponse struct {
	ptr unsafe.Pointer
}

// Free releases the resources held by this handle.
func (h *TowerCachedResponse) Free() {
	if h.ptr != nil {
		C.literllm_tower_cached_response_free((*C.LITERLLMTowerCachedResponse)(h.ptr))
		h.ptr = nil
	}
}
...
// WithRateLimitConfigRpm sets the rpm field.
func WithRateLimitConfigRpm(v uint32) RateLimitConfigOption {
	return func(c *RateLimitConfig) { c.Rpm = &v }
}

// WithRateLimitConfigTpm sets the tpm field.
func WithRateLimitConfigTpm(v uint64) RateLimitConfigOption {
	return func(c *RateLimitConfig) { c.Tpm = &v }
}

// WithRateLimitConfigWindow sets the window field.
func WithRateLimitConfigWindow(v uint64) RateLimitConfigOption {
	return func(c *RateLimitConfig) { c.Window = &v }
}
...
// TowerLlmRequest is an opaque handle type.
type TowerLlmRequest struct {
	ptr unsafe.Pointer
}

// Free releases the resources held by this handle.
func (h *TowerLlmRequest) Free() {
	if h.ptr != nil {
		C.literllm_tower_llm_request_free((*C.LITERLLMTowerLlmRequest)(h.ptr))
		h.ptr = nil
	}
}

// TowerLlmResponse is an opaque handle type.
type TowerLlmResponse struct {
	ptr unsafe.Pointer
}

// Free releases the resources held by this handle.
func (h *TowerLlmResponse) Free() {
	if h.ptr != nil {
		C.literllm_tower_llm_response_free((*C.LITERLLMTowerLlmResponse)(h.ptr))
		h.ptr = nil
	}
}
...
// Default is a method.
func BudgetConfigDefault() *BudgetConfig {
	ptr := C.literllm_budget_config_default()
	defer C.literllm_budget_config_free(ptr)
	return func() *BudgetConfig {
		jsonPtr := C.literllm_budget_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.literllm_free_string(jsonPtr)
...
// Default is a method.
func CacheConfigDefault() *CacheConfig {
	ptr := C.literllm_cache_config_default()
	defer C.literllm_cache_config_free(ptr)
	return func() *CacheConfig {
		jsonPtr := C.literllm_cache_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.literllm_free_string(jsonPtr)
...
// IntoLlmResponse convert this cached response back into the full [`LlmResponse`] enum.
func (h *TowerCachedResponse) IntoLlmResponse() *string {
	ptr := C.literllm_tower_cached_response_into_llm_response((*C.LITERLLMTowerCachedResponse)(unsafe.Pointer(h.ptr)))
	defer C.literllm_free_string(ptr)
	return func() *string {
		if ptr == nil {
			return nil
...
// Default is a method.
func RateLimitConfigDefault() *RateLimitConfig {
	ptr := C.literllm_rate_limit_config_default()
	defer C.literllm_rate_limit_config_free(ptr)
	return func() *RateLimitConfig {
		jsonPtr := C.literllm_rate_limit_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.literllm_free_string(jsonPtr)
...
// OperationName openTelemetry GenAI `gen_ai.operation.name` value for this request.
//
...
func (h *TowerLlmRequest) OperationName() *string {
	ptr := C.literllm_tower_llm_request_operation_name((*C.LITERLLMTowerLlmRequest)(unsafe.Pointer(h.ptr)))
	defer C.literllm_free_string(ptr)
	return func() *string {
		if ptr == nil {
			return nil
...
// RequestType human-readable name of the request type; used as a span / metric label.
func (h *TowerLlmRequest) RequestType() *string {
	ptr := C.literllm_tower_llm_request_request_type((*C.LITERLLMTowerLlmRequest)(unsafe.Pointer(h.ptr)))
	defer C.literllm_free_string(ptr)
	return func() *string {
		if ptr == nil {
			return nil
...
// Model return the model name embedded in the request, if any.
func (h *TowerLlmRequest) Model() *string {
	ptr := C.literllm_tower_llm_request_model((*C.LITERLLMTowerLlmRequest)(unsafe.Pointer(h.ptr)))
	return func() *string {
		if ptr == nil {
			return nil
		}
...
// Usage return the usage data from the response, if present.
//
// Streaming, model-list, and non-chat responses do not carry aggregated
// usage data and always return `None`.
func (h *TowerLlmResponse) Usage() *Usage {
	ptr := C.literllm_tower_llm_response_usage((*C.LITERLLMTowerLlmResponse)(unsafe.Pointer(h.ptr)))
	return func() *Usage {
		jsonPtr := C.literllm_usage_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.literllm_free_string(jsonPtr)
