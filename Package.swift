...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.8.2/LiterLlm-rs.artifactbundle.zip",
      checksum: "f68a36f3de014bfb9756cc04e3d9ea469520a0c54b461d7ea0422f4f759b7023"
    ),
