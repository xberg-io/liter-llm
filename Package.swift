...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.5.0/LiterLlm-rs.artifactbundle.zip",
      checksum: "3369e00c5dba4359ad7835157b8244ed6e156cb16b21538cfdae28c01f78604c"
    ),
