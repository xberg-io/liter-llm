...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.7.3/LiterLlm-rs.artifactbundle.zip",
      checksum: "e969270ad79bdd9ac9f3094caba00dc1b0b9a1c0afb073c2b349c4fb69991fd8"
    ),
