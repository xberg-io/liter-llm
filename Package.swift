...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.7.0/LiterLlm-rs.artifactbundle.zip",
      checksum: "c8642ff6cc6e1e3f554cd083876306b24ae871bd0588cf7bb647546bb1bac642"
    ),
