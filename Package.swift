...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v2.0.3/LiterLlm-rs.artifactbundle.zip",
      checksum: "2f0f0ee087361620f7620249a26b4b05f7b1a78bf73b66e6fb09aea0271f6782"
    ),
