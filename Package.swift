...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.6.1/LiterLlm-rs.artifactbundle.zip",
      checksum: "e100a994f5c3203b1b4b819284da0ed1a2d48c1d414faa18f9b7e283b3a596c3"
    ),
