...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.8.1/LiterLlm-rs.artifactbundle.zip",
      checksum: "140d79d5e356cbdc5aad8f446714eb16380eb4a883652e25e2c9267c662439ba"
    ),
