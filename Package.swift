...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v2.1.0/LiterLlm-rs.artifactbundle.zip",
      checksum: "4f60d5773d4ecd8302457a164bb03fde3793cd4fe92c33d6bbfa5161030a28a1"
    ),
