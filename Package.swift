...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v2.0.1/LiterLlm-rs.artifactbundle.zip",
      checksum: "363e5b0bdb77a5116be11d9d8f4718792f8a6398cd6adc4a5d2e7354ec187faf"
    ),
