...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/liter-llm/releases/download/v1.7.2/LiterLlm-rs.artifactbundle.zip",
      checksum: "3016ee2d3ed707b154ff82cba4332b59296dfba87c4e79c7b17e8785815e5c9a"
    ),
