...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/liter-llm/releases/download/v2.1.1/LiterLlm-rs.artifactbundle.zip",
      checksum: "11baf149945d16add9cfec8fce8a638acc6a0a3794db031f58fc519c51a9187f"
    ),
