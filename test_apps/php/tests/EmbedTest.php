...
final class EmbedTest extends TestCase
{
    ...
    public function test_edge_embed_batch_input(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/edge_embed_batch_input',
        );
        $request = \Liter\Llm\EmbeddingRequest::from_json(json_encode([
    ...
    public function test_edge_embed_empty_input(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/edge_embed_empty_input',
        );
    ...
    public function test_embed_encoding_format(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/embed_encoding_format',
        );
        $request = \Liter\Llm\EmbeddingRequest::from_json(json_encode([
    ...
    public function test_embed_error_401(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/embed_error_401',
        );
    ...
    public function test_embed_with_dimensions(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/embed_with_dimensions',
        );
        $request = \Liter\Llm\EmbeddingRequest::from_json(json_encode([
            'dimensions' => 256,
            'input' => 'Hello world',
    ...
    public function test_local_embed_ollama(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/local_embed_ollama',
        );
        $request = \Liter\Llm\EmbeddingRequest::from_json(json_encode([
