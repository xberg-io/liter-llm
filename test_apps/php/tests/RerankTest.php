...
final class RerankTest extends TestCase
{
    ...
    public function test_edge_rerank_empty_query(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/edge_rerank_empty_query',
        );
        $request = \Liter\Llm\RerankRequest::from_json(json_encode([
    ...
    public function test_edge_rerank_single_doc(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/edge_rerank_single_doc',
        );
        $request = \Liter\Llm\RerankRequest::from_json(json_encode([
    ...
    public function test_error_rerank_auth_401(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/error_rerank_auth_401',
        );
    ...
    public function test_error_rerank_bad_request(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/error_rerank_bad_request',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\RerankRequest::from_json(json_encode([
            'documents' => ['doc1'],
    ...
    public function test_smoke_rerank_basic(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/smoke_rerank_basic',
        );
        $request = \Liter\Llm\RerankRequest::from_json(json_encode([
            'documents' => [
    ...
    public function test_smoke_rerank_return_docs(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/smoke_rerank_return_docs',
        );
        $request = \Liter\Llm\RerankRequest::from_json(json_encode([
    ...
    public function test_smoke_rerank_with_top_n(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/smoke_rerank_with_top_n',
        );
        $request = \Liter\Llm\RerankRequest::from_json(json_encode([
            'documents' => [
