...
describe("tool-calling", () => {
  it("anthropic_tool_calling: Chat request to Anthropic provider with a tool definition; assistant responds with a tool call", async () => {
    ...
    const result = await client.chat(
      (() => {
        ...
        _u0.maxTokens = 256n;
        _u0.messages = [{ content: "What is the weather in London?", role: "user" }];
            ...
            _u1.function = (() => {
              ...
              _u2.parameters = {
                properties: {
                  ...
                  unit: { description: "The temperature unit to use", enum: ["celsius", "fahrenheit"], type: "string" },
                },
                required: ["location"],
                type: "object",
              };
  ...
  it("single_tool_call: Chat request with a tool definition; assistant responds with a tool call", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "What is the weather in San Francisco?", role: "user" }];
        _u0.model = "gpt-4";
        _u0.toolChoice = "auto";
        _u0.tools = [
          (() => {
