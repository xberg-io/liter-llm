  ...
  it("error_batch_auth_401: 401 Unauthorized when creating a batch with invalid API key", async () => {
    ...
    await expect(async () => {
      await client.createBatch(
        (() => {
          const _u0 = WasmCreateBatchRequest.default();
          _u0.completionWindow = "24h";
          _u0.endpoint = "/v1/chat/completions";
          _u0.inputFileId = "file-abc123";
          return _u0;
        })(),
      );
    }).rejects.toThrow();
    ...
    await expect(async () => {
      await client.createBatch(
        (() => {
          ...
          _u0.completionWindow = "24h";
          _u0.endpoint = "/v1/chat/completions";
          _u0.inputFileId = "file-wrong-purpose";
          return _u0;
        })(),
      );
    }).rejects.toThrow();
