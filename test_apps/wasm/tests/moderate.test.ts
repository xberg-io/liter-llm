...
describe("moderate", () => {
  it("edge_moderate_all_categories: Moderation response with multiple categories flagged", async () => {
    ...
    const result = await client.moderate(
      (() => {
        const _u0 = WasmModerationRequest.default();
        _u0.input = "Extremely harmful content targeting multiple categories";
        _u0.model = "omni-moderation-latest";
        return _u0;
      })(),
    );
    ...
    await expect(async () => {
      await client.moderate(
        (() => {
          const _u0 = WasmModerationRequest.default();
          _u0.input = "Hello";
          _u0.model = "nonexistent-moderation";
          return _u0;
        })(),
      );
    }).rejects.toThrow();
  ...
  it("smoke_moderate_batch: Moderate multiple inputs in a single request", async () => {
    ...
    const result = await client.moderate(
      (() => {
        const _u0 = WasmModerationRequest.default();
        _u0.input = ["Hello world", "Nice weather today"];
        _u0.model = "omni-moderation-latest";
        return _u0;
      })(),
    );
  ...
  it("smoke_moderate_flagged: Moderation detects flagged content", async () => {
    ...
    const result = await client.moderate(
      (() => {
        const _u0 = WasmModerationRequest.default();
        _u0.input = "I want to hurt someone very badly";
        _u0.model = "omni-moderation-latest";
        return _u0;
      })(),
    );
  ...
  it("smoke_moderate_single: Moderate a single non-flagged input", async () => {
    ...
    const result = await client.moderate(
      (() => {
        const _u0 = WasmModerationRequest.default();
        _u0.input = "The weather is nice today.";
        _u0.model = "omni-moderation-latest";
        return _u0;
      })(),
    );
