...
import { createClient, WasmChatCompletionRequest, WasmCreateSpeechRequest, WasmChatCompletionTool, WasmFunctionDefinition, WasmStreamOptions } from "@kreuzberg/liter-llm-wasm";
