...
describe("chat", () => {
  ...
  it("edge_chat_max_tokens: Chat request with max_tokens=1 terminates with length finish_reason", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.maxTokens = 1n;
        _u0.messages = [{ content: "Write a story", role: "user" }];
        _u0.model = "gpt-4";
        return _u0;
      })(),
    );
  ...
  it("finish_reason_content_filter: Chat response stopped by content filter with finish_reason of content_filter and null content", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "Tell me something controversial", role: "user" }];
        _u0.model = "gpt-4";
        return _u0;
      })(),
    );
  ...
  it("finish_reason_length: Chat response truncated due to max_tokens limit with finish_reason of length", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.maxTokens = 5n;
        _u0.messages = [{ content: "Tell me a long story", role: "user" }];
        _u0.model = "gpt-4";
        return _u0;
      })(),
    );
  ...
  it("parallel_tool_calls: Chat request that results in parallel tool calls in the response", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "What is the weather in NYC and London?", role: "user" }];
        _u0.model = "gpt-4";
        _u0.parallelToolCalls = true;
        _u0.tools = [
          (() => {
  ...
  it("response_format_json_object: Chat request with response_format json_object that returns valid JSON content", async () => {
    ...
    const result = await client.chat(
      (() => {
        ...
        _u0.model = "gpt-4";
        _u0.responseFormat = { type: "json_object" };
        return _u0;
      })(),
    );
    expect(result.choices.length).toBe(1);
  ...
  it("response_format_json_schema: Chat request with response_format json_schema that validates the output structure", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "What is the temperature in Paris today?", role: "user" }];
        _u0.model = "gpt-4";
        _u0.responseFormat = {
          jsonSchema: {
            name: "weather",
  ...
  it("seed_parameter: Chat request with seed parameter for deterministic output; response includes system_fingerprint", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "Pick a random number", role: "user" }];
        _u0.model = "gpt-4";
        _u0.seed = 42n;
        return _u0;
      })(),
  ...
  it("stop_sequences: Chat request with custom stop sequences that terminates generation at a stop token", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "List items until you see STOP", role: "user" }];
        _u0.model = "gpt-4";
        _u0.stop = ["STOP", "END"];
        return _u0;
      })(),
  ...
  it("tool_choice_required: Chat request with tool_choice set to required forces the model to call a tool", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "What is the weather today?", role: "user" }];
        _u0.model = "gpt-4";
        _u0.toolChoice = "required";
        _u0.tools = [
          (() => {
            const _u1 = WasmChatCompletionTool.default();
            _u1.function = (() => {
  ...
  it("tool_choice_specific: Chat request with tool_choice specifying a particular function to call", async () => {
    ...
    const result = await client.chat(
      (() => {
        const _u0 = WasmChatCompletionRequest.default();
        _u0.messages = [{ content: "What is the weather in Paris?", role: "user" }];
        _u0.model = "gpt-4";
        _u0.toolChoice = { function: { name: "get_weather" }, type: "function" };
        _u0.tools = [
          (() => {
            const _u1 = WasmChatCompletionTool.default();
            _u1.function = (() => {
          ...
          (() => {
            ...
            _u1.function = (() => {
              const _u2 = WasmFunctionDefinition.default();
              _u2.description = "Search the web for information";
              _u2.name = "search_web";
              _u2.parameters = {
