...
final class ChatTests: XCTestCase {
    ...
    func testEdgeChatMaxTokens() async throws {
        ...
        XCTAssertEqual((_vec_choices_equals_3ce619d2[0].finishReason()?.toString() ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "length")
    ...
    func testFinishReasonContentFilter() async throws {
        ...
        XCTAssertEqual((_vec_choices_equals_eda78af[0].finishReason()?.toString() ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "content_filter")
    }
