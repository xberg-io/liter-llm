...
final class ChatTests: XCTestCase {
    ...
    func testDeveloperMessage() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/developer_message")
    ...
    func testEdgeChatMaxTokens() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_chat_max_tokens")
        let result = try await _client.chat(_request)
    ...
    func testEdgeChatSystemOnly() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_chat_system_only")
        let result = try await _client.chat(_request)
        XCTAssertNotNil(result.choices[0].message.content, "expected non-nil value")
    }
    ...
    func testEdgeChatTemperatureZero() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_chat_temperature_zero")
        let result = try await _client.chat(_request)
        XCTAssertNotNil(result.choices[0].message.content, "expected non-nil value")
    }
    ...
    func testFinishReasonContentFilter() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/finish_reason_content_filter")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
    ...
    func testFinishReasonLength() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/finish_reason_length")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertEqual(((result.choices[0].finishReason)?.rawValue ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "length")
    }
    ...
    func testMultiTurnConversation() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/multi_turn_conversation")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
    ...
    func testParallelToolCalls() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/parallel_tool_calls")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
    ...
    func testResponseFormatJsonObject() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/response_format_json_object")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertNotNil(result.choices[0].message.content, "expected non-nil value")
        XCTAssertEqual(((result.choices[0].finishReason)?.rawValue ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "stop")
    ...
    func testResponseFormatJsonSchema() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/response_format_json_schema")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertNotNil(result.choices[0].message.content, "expected non-nil value")
        XCTAssertEqual(((result.choices[0].finishReason)?.rawValue ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "stop")
    ...
    func testSeedParameter() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/seed_parameter")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertEqual(((result.choices[0].finishReason)?.rawValue ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "stop")
    ...
    func testStopSequences() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/stop_sequences")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertEqual(((result.choices[0].finishReason)?.rawValue ?? "").trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "stop")
    }
    ...
    func testToolChoiceRequired() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/tool_choice_required")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertNotNil(result.choices[0].message.toolCalls, "expected non-nil value")
    ...
    func testToolChoiceSpecific() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/tool_choice_specific")
        let result = try await _client.chat(_request)
        XCTAssertEqual(result.choices.count, 1)
        XCTAssertNotNil(result.choices[0].message.toolCalls, "expected non-nil value")
        XCTAssertEqual(result.choices[0].message.toolCalls?[0].function.name.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines), "get_weather")
