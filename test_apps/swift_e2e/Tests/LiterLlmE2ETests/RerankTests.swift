...
final class RerankTests: XCTestCase {
    func testEdgeRerankEmptyQuery() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_rerank_empty_query")
    ...
    func testEdgeRerankSingleDoc() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_rerank_single_doc")
        let result = try await _client.rerank(_request)
    ...
    func testErrorRerankAuth401() async throws {
        ...
        do {
            ...
            let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/error_rerank_auth_401")
    ...
    func testErrorRerankBadRequest() async throws {
        ...
        do {
            ...
            let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/error_rerank_bad_request")
            _ = try await _client.rerank(_request)
            XCTFail("expected to throw")
        } catch {
            // success
    ...
    func testSmokeRerankBasic() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/smoke_rerank_basic")
        let result = try await _client.rerank(_request)
    ...
    func testSmokeRerankReturnDocs() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/smoke_rerank_return_docs")
        let result = try await _client.rerank(_request)
        XCTAssertEqual(result.results().count, 2)
    ...
    func testSmokeRerankWithTopN() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/smoke_rerank_with_top_n")
        let result = try await _client.rerank(_request)
        XCTAssertEqual(result.results().count, 2)
        let _vec_results_greater_than_871844e6 = result.results()
        XCTAssertGreaterThan(_vec_results_greater_than_871844e6[0].relevanceScore(), 0.9)
