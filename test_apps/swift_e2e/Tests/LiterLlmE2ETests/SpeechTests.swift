...
final class SpeechTests: XCTestCase {
    func testEdgeSpeechAllVoices() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_speech_all_voices")
    ...
    func testEdgeSpeechLongInput() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/edge_speech_long_input")
        let result = try await _client.speech(_request)
        XCTAssertFalse(result.isEmpty, "expected non-empty value")
    }
    ...
    func testErrorSpeechAuth401() async throws {
        ...
        do {
            ...
            let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/error_speech_auth_401")
    ...
    func testErrorSpeechBadModel() async throws {
        ...
        do {
            ...
            let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/error_speech_bad_model")
            _ = try await _client.speech(_request)
            XCTFail("expected to throw")
        } catch {
            // success
    ...
    func testSmokeSpeechBasic() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/smoke_speech_basic")
        let result = try await _client.speech(_request)
        XCTAssertFalse(result.isEmpty, "expected non-empty value")
    }
    ...
    func testSmokeSpeechMp3Format() async throws {
        ...
        let _client = try DefaultClient(apiKey: "test-key", baseUrl: AlefE2EMockServer.baseURL + "/fixtures/smoke_speech_mp3_format")
        let result = try await _client.speech(_request)
        XCTAssertFalse(result.isEmpty, "expected non-empty value")
    }
