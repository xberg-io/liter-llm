...
//   sample-llm: mock_response: { status, body, stream_chunks }
//   sample_project:   http.expected_response: { status_code, body, headers }
// ---------------------------------------------------------------------------
...
struct Fixture {
    ...
    /// Used by sample-crawler-style fixtures that mock multiple URLs per fixture (e.g. a page +
...
impl Fixture {
    ...
    /// element per array entry for the sample-crawler-style `input.mock_responses` schema. For the
