...
async def test_edge_chat_max_tokens() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/edge_chat_max_tokens"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_edge_chat_system_only() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/edge_chat_system_only"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_edge_chat_temperature_zero() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/edge_chat_temperature_zero"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_finish_reason_content_filter() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/finish_reason_content_filter"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_finish_reason_length() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/finish_reason_length"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_multi_turn_conversation() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/multi_turn_conversation"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_response_format_json_object() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/response_format_json_object"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_response_format_json_schema() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/response_format_json_schema"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_tool_choice_required() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/tool_choice_required"
    )
    request = ChatCompletionRequest.from_json(
...
async def test_tool_choice_specific() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/tool_choice_specific"
    )
    request = ChatCompletionRequest.from_json(
