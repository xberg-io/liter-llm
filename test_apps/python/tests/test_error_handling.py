...
async def test_anthropic_error_auth() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/anthropic_error_auth"
        )
...
async def test_azure_error_auth() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/azure_error_auth"
        )
        request = ChatCompletionRequest.from_json(
...
async def test_bedrock_error_auth() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/bedrock_error_auth"
        )
        request = ChatCompletionRequest.from_json(
...
async def test_content_policy_violation() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/content_policy_violation"
        )
        request = ChatCompletionRequest.from_json(
...
async def test_context_window_exceeded() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/context_window_exceeded"
        )
        request = ChatCompletionRequest.from_json(
...
async def test_empty_response_body() -> None:
    ...
    with pytest.raises(Exception):  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/empty_response_body"
        )
        request = ChatCompletionRequest.from_json('{"messages":[{"content":"Hello","role":"user"}],"model":"gpt-4"}')
        await client.chat(request)
...
async def test_gateway_timeout_504() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/gateway_timeout_504"
        )
        request = ChatCompletionRequest.from_json('{"messages":[{"content":"Hello","role":"user"}],"model":"gpt-4"}')
        await client.chat(request)
...
async def test_github_copilot_error_auth() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/github_copilot_error_auth"
        )
        request = ChatCompletionRequest.from_json(
...
async def test_server_error_500() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/server_error_500"
        )
        request = ChatCompletionRequest.from_json('{"messages":[{"content":"Hello","role":"user"}],"model":"gpt-4"}')
        await client.chat(request)
...
async def test_service_unavailable_502() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/service_unavailable_502"
        )
        request = ChatCompletionRequest.from_json('{"messages":[{"content":"Hello","role":"user"}],"model":"gpt-4"}')
        await client.chat(request)
    assert "ServiceUnavailable" in str(exc_info.value) or "ServiceUnavailable" in type(exc_info.value).__name__  # noqa: S101
...
async def test_vertex_error_auth() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        client = create_client(
            api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/vertex_error_auth"
        )
        request = ChatCompletionRequest.from_json(
