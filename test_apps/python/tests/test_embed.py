...
from liter_llm import create_client, EmbeddingRequest, EmbeddingFormat, EmbeddingInput
...
async def test_edge_embed_batch_input() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/edge_embed_batch_input"
    )
...
async def test_edge_embed_empty_input() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/edge_embed_empty_input"
    )
...
async def test_embed_encoding_format() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/embed_encoding_format"
    )
...
async def test_embed_with_dimensions() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/embed_with_dimensions"
    )
