...
// alef:hash:c36363fc70ac348979013b05c45d81b422fdc4f7716fb9554bc82867430098b2
...
void test_edge_image_b64_response(void) {
    ...
    LITERLLMImageResponse* result = literllm_default_client_image_generate(client, create_image_request_handle);
