 ...
 * alef:hash:e2ed24d6bd254bae2f9bee0312555403133f951181feb6b6b8717207deccd6b2
...
void test_smoke_streaming_openai(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client(api_key, _base_url_arg, (uint64_t)-1, (uint32_t)-1, NULL);
    assert(client != NULL && "failed to create client");
    LiterllmDefaultClientChatStreamStreamHandle* stream_handle = literllm_default_client_chat_stream_start(client, chat_completion_request_handle);
