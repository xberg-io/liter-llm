...
// alef:hash:070846a5541640e35a1908ec7d96d25d41103b8cfda59858fb0b82d1aa95840b
...
void test_error_batch_auth_401(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client("test-key", NULL, 0, 0, NULL);
    assert(client != NULL && "failed to create client");
    LITERLLMBatchResponse* result = literllm_default_client_create_batch(client, create_batch_request_handle);
