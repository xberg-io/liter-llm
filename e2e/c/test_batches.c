...
// alef:hash:7b73a600d06fefae17a554fbe43b30edf1e2b2b0a1340441c5a71808d4395acd
...
void test_edge_batch_already_cancelled(void) {
    ...
    LITERLLMBatchObject* result = literllm_default_client_cancel_batch(client);
...
void test_edge_batch_empty_list(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client("test-key", NULL, 0, 0, NULL);
    assert(client != NULL && "failed to create client");
    LITERLLMBatchListResponse* result = literllm_default_client_list_batches(client);
...
void test_error_batch_not_found(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client("test-key", NULL, 0, 0, NULL);
    assert(client != NULL && "failed to create client");
    LITERLLMBatchObject* result = literllm_default_client_retrieve_batch(client);
    literllm_default_client_free(client);
    assert(result == NULL && "expected call to fail");
}
