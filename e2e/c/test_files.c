...
// alef:hash:bfcaae9066725278260f561b5d12ea6b1a5dfdecac9e5707fc8ce55435558220
...
void test_edge_file_empty_list(void) {
    ...
    LITERLLMFileListResponse* result = literllm_default_client_list_files(client);
...
void test_error_file_not_found(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client("test-key", NULL, 0, 0, NULL);
    assert(client != NULL && "failed to create client");
    LITERLLMFileObject* result = literllm_default_client_retrieve_file(client);
    literllm_default_client_free(client);
    assert(result == NULL && "expected call to fail");
}
...
void test_smoke_delete_file(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client("test-key", NULL, 0, 0, NULL);
    assert(client != NULL && "failed to create client");
    LITERLLMDeleteResponse* result = literllm_default_client_delete_file(client);
    assert(result != NULL && "expected call to succeed");
    char* id = literllm_delete_response_id(result);
    char* deleted = literllm_delete_response_deleted(result);
    assert(id != NULL && strlen(id) > 0 && "expected non-empty value");
