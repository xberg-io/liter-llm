...
// alef:hash:d5da83f54a0ac337a46b26c9224f5b7e5c7861dbae568159e5c255618b6c2672
...
void test_edge_file_large_upload(void) {
    ...
    LITERLLMDefaultClient* client = literllm_create_client("test-key", NULL, 0, 0, NULL);
    assert(client != NULL && "failed to create client");
    LITERLLMFileResponse* result = literllm_default_client_create_file(client, create_file_request_handle);
    assert(result != NULL && "expected call to succeed");
