...
async def test_local_provider_llamacpp() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/local_provider_llamacpp"
    )
...
async def test_local_provider_ollama() -> None:
    ...
    client = create_client(
        api_key="test-key", base_url=os.environ["MOCK_SERVER_URL"] + "/fixtures/local_provider_ollama"
    )
    request = ChatCompletionRequest.from_json(
