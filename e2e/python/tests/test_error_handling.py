...
# alef:hash:dd37c8bb7774af0dbc3e544bc7643ed59f2615b1be3275d55bb9c91278a9d79b
...
async def test_context_window_exceeded() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await client.chat(request)
    assert (
        "ContextWindowExceeded" in str(exc_info.value)
        or "ContextWindowExceeded" in type(exc_info.value).__name__
    )  # noqa: S101
...
async def test_gateway_timeout_504() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await client.chat(request)
    assert (
        "ServiceUnavailable" in str(exc_info.value)
        or "ServiceUnavailable" in type(exc_info.value).__name__
    )  # noqa: S101
...
async def test_rate_limit_429() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await client.chat(request)
    assert (
        "RateLimited" in str(exc_info.value)
        or "RateLimited" in type(exc_info.value).__name__
    )  # noqa: S101
...
async def test_server_error_500() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await client.chat(request)
    assert (
        "ServerError" in str(exc_info.value)
        or "ServerError" in type(exc_info.value).__name__
    )  # noqa: S101
...
async def test_timeout_error() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await client.chat(request)
    assert (
        "Timeout" in str(exc_info.value) or "Timeout" in type(exc_info.value).__name__
    )  # noqa: S101
