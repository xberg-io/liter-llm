...
# alef:hash:0e077f9d1e519ae1128bdf9c519ee9d2b3c90b6e860125a402261a4c3ef01b58
...
def test_stream_content_policy_error() -> None:
    ...
    assert (
        "ContentPolicy" in str(exc_info.value)
        or "ContentPolicy" in type(exc_info.value).__name__
    )  # noqa: S101
