...
// alef:hash:63a3118b08ef6df3d292aa41ed800d97c0d1870d085eb2dddbba89cefde5958c
    ...
    for path in paths {
        if path.is_dir() {
            ...
            for fixture in fixtures {
                ...
                let has_host_root =
                    has_intra_fixture_redirect || resolved_routes.iter().any(|r| is_host_root_path(&r.original_path));
