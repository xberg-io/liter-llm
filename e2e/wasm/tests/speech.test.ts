...
// alef:hash:289006345ec1ece177a06aaefbbe2087f86234f46c54d8a6e46cb438a85a0600
// To regenerate: alef generate
// To verify freshness: alef verify --exit-code
// Issues & docs: https://github.com/kreuzberg-dev/alef

import { describe, expect, it } from "vitest";
import { createClient, WasmChatCompletionRequest, WasmCreateSpeechRequest } from "liter_llm";
...
describe("speech", () => {
  it("edge_speech_all_voices: Text-to-speech with specific voice selection", async () => {
    ...
    const result = await client.speech(
      (() => {
        const _u = new WasmCreateSpeechRequest();
