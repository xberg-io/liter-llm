...
describe("image-generate", () => {
  it("edge_image_b64_response: Image generation returning base64-encoded data instead of URL", async () => {
    ...
    const result = await client.imageGenerate(
      (() => {
        const _u0 = WasmCreateImageRequest.default();
        _u0.model = "dall-e-3";
        _u0.n = 1;
        _u0.prompt = "A blue circle";
        _u0.responseFormat = "b64_json";
        _u0.size = "1024x1024";
        return _u0;
      })(),
    );
  ...
  it("smoke_image_basic: Basic image generation with a text prompt", async () => {
    ...
    const result = await client.imageGenerate(
      (() => {
        ...
        _u0.model = "dall-e-3";
        _u0.n = 1;
        _u0.prompt = "A white cat sitting on a windowsill";
        _u0.size = "1024x1024";
        return _u0;
      })(),
    );
  ...
  it("smoke_image_with_size: Image generation with explicit size parameter", async () => {
    ...
    const result = await client.imageGenerate(
      (() => {
        ...
        _u0.model = "dall-e-3";
        _u0.n = 1;
        _u0.prompt = "A sunset over mountains";
        _u0.size = "1792x1024";
        return _u0;
      })(),
    );
