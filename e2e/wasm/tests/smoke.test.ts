...
// alef:hash:84ced8466ae207996bbe4f682a5d9f7896277923131aa621bac6452c0bc56b38
    ...
    const result = await client.chat(
      (() => {
        ...
        _u.messages = [
          ...
          (() => {
            const _u = new WasmMessage();
            _u.content = "Say hello in one word.";
            _u.role = "user";
            return _u;
          })(),
        ];
    ...
    const result = await client.chat(
      (() => {
        ...
        _u.messages = [
          (() => {
            const _u = new WasmMessage();
            _u.content = "What is 2+2? Answer with just the number.";
            _u.role = "user";
            return _u;
          })(),
        ];
    ...
    const result = await client.chat(
      (() => {
        ...
        _u.messages = [
          (() => {
            const _u = new WasmMessage();
            _u.content = "Say hello in exactly one word.";
            _u.role = "user";
            return _u;
          })(),
        ];
