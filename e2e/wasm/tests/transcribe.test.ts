...
// alef:hash:ef9fe96ce88d3b6af1631fd75d9751faae92f774161df1f8cafe3459116bae4a
// To regenerate: alef generate
// To verify freshness: alef verify --exit-code
// Issues & docs: https://github.com/kreuzberg-dev/alef

import { describe, expect, it } from "vitest";
import { createClient, WasmChatCompletionRequest, WasmCreateTranscriptionRequest } from "liter_llm";
...
describe("transcribe", () => {
  it("edge_transcribe_empty_audio: Transcription of a silent or empty audio file returns empty text", async () => {
    ...
    const result = await client.transcribe(
      (() => {
        const _u = new WasmCreateTranscriptionRequest();
        _u.file = "silence.mp3";
        _u.model = "whisper-1";
        return _u;
      })(),
