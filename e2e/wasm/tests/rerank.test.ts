...
describe("rerank", () => {
  it("edge_rerank_empty_query: Reranking with an empty query string", async () => {
    ...
    const result = await client.rerank(
      (() => {
        const _u0 = WasmRerankRequest.default();
        _u0.documents = ["Some document", "Another document"];
        _u0.model = "rerank-v3.5";
        _u0.query = "";
        return _u0;
      })(),
    );
  ...
  it("edge_rerank_single_doc: Reranking with only a single document", async () => {
    ...
    const result = await client.rerank(
      (() => {
        const _u0 = WasmRerankRequest.default();
        _u0.documents = ["Artificial intelligence is the simulation of human intelligence."];
        _u0.model = "rerank-v3.5";
        _u0.query = "What is AI?";
        return _u0;
      })(),
    );
  ...
  it("smoke_rerank_basic: Basic reranking of documents against a query", async () => {
    ...
    const result = await client.rerank(
      (() => {
        ...
        _u0.model = "rerank-v3.5";
        _u0.query = "What is machine learning?";
        return _u0;
      })(),
    );
  ...
  it("smoke_rerank_return_docs: Reranking with return_documents flag to include document text", async () => {
    ...
    const result = await client.rerank(
      (() => {
        const _u0 = WasmRerankRequest.default();
        _u0.documents = ["Rust is a systems programming language.", "Iron rusts when exposed to water."];
        _u0.model = "rerank-v3.5";
        _u0.query = "What is Rust?";
        _u0.returnDocuments = true;
        return _u0;
      })(),
    );
    expect(result.results.length).toBe(2);
