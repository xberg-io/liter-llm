...
// alef:hash:91a6130faaa3b6ea3aa213f82828d17c85cb095264ef23fde70210de0eaa658e
	...
	it("context_window_exceeded: 400 error when the prompt exceeds the model's maximum context length", async () => {
		...
		await expect(async () => {
			await client.chat(
				(() => {
					const _u = WasmChatCompletionRequest.default();
					_u.messages = [{ content: "Very long prompt that exceeds the context window...", role: "user" }];
					_u.model = "gpt-4";
					return _u;
				})(),
			);
