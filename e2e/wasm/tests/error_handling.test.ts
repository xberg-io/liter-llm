...
// alef:hash:6279a9ae5df70deb943f3523339e342462f5824e06e1b983177ef1fb55bba23c
      ...
      await client.chat(
        (() => {
          ...
          _u.messages = [
            (() => {
              const _u = new WasmMessage();
              _u.content = "Generate harmful content";
              _u.role = "user";
              return _u;
            })(),
          ];
      ...
      await client.chat(
        (() => {
          ...
          _u.messages = [
            (() => {
              const _u = new WasmMessage();
              _u.content = "Very long prompt that exceeds the context window...";
              _u.role = "user";
              return _u;
            })(),
          ];
