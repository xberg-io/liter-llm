...
// alef:hash:93f4a9a23448ef6a557f180b044a4eee31af2bbd7995e520baf58f5659fe30b1
      ...
      (() => {
        ...
        _u.messages = [
          (() => {
            ...
            _u.content = "Count to three, one word per response.";
            _u.role = "user";
            return _u;
          })(),
        ];
    ...
    await client.chatStream(
      (() => {
        ...
        _u.messages = [
          (() => {
            const _u = new WasmMessage();
            _u.content = "What is the weather in NYC?";
            _u.role = "user";
            return _u;
          })(),
        ];
