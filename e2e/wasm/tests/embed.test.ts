...
describe("embed", () => {
	...
	it("embed_base64: Embedding request with encoding_format base64 decodes to a float array embedding", async () => {
		...
		const result = await client.embed((() => { const _u0 = WasmEmbeddingRequest.default(); _u0.encodingFormat = "base64"; _u0.input = "Test input"; _u0.model = "text-embedding-3-small"; return _u0; })());
