...
// alef:hash:068ad7995d37c79fd37c376244dc58953bbdbcc4d52015879f1fad65a526525c
// To regenerate: alef generate
// To verify freshness: alef verify --exit-code
// Issues & docs: https://github.com/kreuzberg-dev/alef

import { describe, expect, it } from "vitest";
import { createClient, WasmChatCompletionRequest, WasmSearchRequest } from "liter_llm";
...
describe("search", () => {
  it("search_basic: Basic web search request with a simple query", async () => {
    ...
    await client.search(
      (() => {
        const _u = new WasmSearchRequest();
