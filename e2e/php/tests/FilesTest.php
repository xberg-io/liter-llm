...
// alef:hash:62d1b874f340234f5bdefc1e96b24008667b47c310d84a2d96249659fcd38511
...
final class FilesTest extends TestCase
{
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->listFiles();
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->createFile(null);
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->deleteFile("file-abc123");
            $this->assertNotEmpty($result->id);
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->fileContent("file-abc123");
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->retrieveFile("file-abc123");
            $this->assertNotEmpty($result->id);
    }
