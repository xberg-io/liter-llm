...
// alef:hash:2963c9f3c4b4ba9ded9e9e2090226a27b1ac0ffbefffacb276799a6230037d5c
...
final class EmbedTest extends TestCase
{
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->embed(json_encode(["Hello world", "Goodbye world"]));
            $this->assertCount(2, $result->data);
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->embed(json_encode(""));
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->embed(json_encode("Test input"));
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $this->expectException(\Exception::class);
        $client->embed(json_encode("Hello world"));    }
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key');        $result = $client->embed(json_encode("The quick brown fox jumps over the lazy dog"));
            $this->assertCount(1, $result->data);
