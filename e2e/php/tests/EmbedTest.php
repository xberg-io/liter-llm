...
// alef:hash:cc205b6754678dfb0410e691ce1886fd11f831c240ceada84a059fc30063a4b5
...
final class EmbedTest extends TestCase
{
    ...
    {        $client = \Liter\Llm\LiterLlm::createClient('test-key', getenv('MOCK_SERVER_URL') . '/fixtures/embed_encoding_format');
        $request = \Liter\Llm\EmbeddingRequest::from_json(json_encode(["encoding_format" => "float", "input" => "Test input", "model" => "text-embedding-3-small"]));
        $result = $client->embed($request);
