...
final class ErrorHandlingTest extends TestCase
{
    ...
    public function test_anthropic_error_auth(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/anthropic_error_auth',
        );
    ...
    public function test_azure_error_auth(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/azure_error_auth',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_bad_request_400(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/bad_request_400',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_bedrock_error_auth(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/bedrock_error_auth',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_content_policy_violation(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/content_policy_violation',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
    ...
    public function test_context_window_exceeded(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/context_window_exceeded',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
    ...
    public function test_empty_response_body(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/empty_response_body',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_gateway_timeout_504(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/gateway_timeout_504',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_github_copilot_error_auth(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/github_copilot_error_auth',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_server_error_500(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/server_error_500',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_service_unavailable_502(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/service_unavailable_502',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
    ...
    public function test_vertex_error_auth(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/vertex_error_auth',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\ChatCompletionRequest::from_json(json_encode([
            'messages' => [['content' => 'Hello', 'role' => 'user']],
