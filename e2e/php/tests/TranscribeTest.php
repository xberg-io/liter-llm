...
final class TranscribeTest extends TestCase
{
    ...
    public function test_edge_transcribe_empty_audio(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/edge_transcribe_empty_audio',
        );
        $request = \Liter\Llm\CreateTranscriptionRequest::from_json(json_encode([
            'file' => 'silence.mp3',
            'model' => 'whisper-1',
        ]));
    ...
    public function test_edge_transcribe_with_timestamps(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/edge_transcribe_with_timestamps',
        );
        $request = \Liter\Llm\CreateTranscriptionRequest::from_json(json_encode([
            'file' => 'audio.mp3',
            'model' => 'whisper-1',
    ...
    public function test_error_transcribe_auth_401(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/error_transcribe_auth_401',
        );
    ...
    public function test_error_transcribe_bad_format(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/error_transcribe_bad_format',
        );
        $this->expectException(\Exception::class);
        $request = \Liter\Llm\CreateTranscriptionRequest::from_json(json_encode([
            'file' => 'audio.xyz',
    ...
    public function test_smoke_transcribe_basic(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/smoke_transcribe_basic',
        );
        $request = \Liter\Llm\CreateTranscriptionRequest::from_json(json_encode([
            'file' => 'audio.mp3',
            'model' => 'whisper-1',
    ...
    public function test_smoke_transcribe_with_language(): void
    {
        $client = \Liter\Llm\LiterLlm::createClient(
            'test-key',
            getenv('MOCK_SERVER_URL') . '/fixtures/smoke_transcribe_with_language',
        );
        $request = \Liter\Llm\CreateTranscriptionRequest::from_json(json_encode([
            'file' => 'audio_de.mp3',
            'language' => 'de',
        ...
        $this->assertStringContainsString('Hallo, dies ist in Testtranskription.', $result->text);
    }
}
