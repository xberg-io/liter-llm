...
See the `Error Handling` section of each language reference for full class inheritance, retry helpers, and runnable examples: [Python](../reference/api-python.md#errors), [TypeScript](../reference/api-typescript.md#errors), [Rust](../reference/api-rust.md#errors), [Go](../reference/api-go.md#errors), [Java](../reference/api-java.md#errors), [C#](../reference/api-csharp.md#errors), [Ruby](../reference/api-ruby.md#errors), [Elixir](../reference/api-elixir.md#errors), [PHP](../reference/api-php.md#errors), [WASM](../reference/api-wasm.md#errors), [C FFI](../reference/api-c.md#errors).
