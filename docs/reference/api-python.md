...
| `usage`  | `Usage \| None`         | `None`  | Token usage (input tokens only; embeddings have zero output tokens).                                                                  |
...
| `description` | `str \| None`            | `None`  | Human-readable description explaining what the function does.          |
| `parameters`  | `dict[str, Any] \| None` | `None`  | JSON Schema defining the function's parameters.                        |
| `strict`      | `bool \| None`           | `None`  | If true, enforce strict JSON schema validation for arguments.          |
...
| `image_base64` | `str \| None` | `None`  | Base64-encoded image data (if `include_image_base64` was true). |
...
| `images`     | `list[OcrImage] \| None` | `None`  | Embedded images extracted from the page (if `include_image_base64` was true). |
...
| `meta`    | `dict[str, Any] \| None` | `None`  | Optional metadata about the reranking operation. |
...
| `document`        | `RerankResultDocument \| None` | `None`  | Original document content (if `return_documents` was true).  |
