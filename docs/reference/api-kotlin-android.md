...
## Kotlin (Android) API Reference <span class="version-badge">v1.7.5</span>
...
```kotlin
val result = instance.refusalText()
```
...
```kotlin
val result = instance.outputImages()
```
...
```kotlin
val result = instance.outputAudio()
```
