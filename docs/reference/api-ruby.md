...
| `parameters`  | `Object?`  | `nil`   | JSON Schema defining the function's parameters.                        |
| `strict`      | `Boolean?` | `nil`   | If true, enforce strict JSON schema validation for arguments.          |
...
| `image_base64` | `String?` | `nil`   | Base64-encoded image data (if `include_image_base64` was true). |
...
| `images`     | `Array<OcrImage>?` | `nil`   | Embedded images extracted from the page (if `include_image_base64` was true). |
...
| `meta`    | `Object?`             | `nil`   | Optional metadata about the reranking operation. |
