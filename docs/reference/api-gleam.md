...
---
## Gleam API Reference <span class="version-badge">v1.4.0-rc.27</span>
### Functions
...
| `logitBias` | `Dict(String, Float)?` | `{}` | Token bias map.  Uses `BTreeMap` (sorted keys) for deterministic serialization order — important when hashing or signing requests. |
