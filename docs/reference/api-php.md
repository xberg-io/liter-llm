...
| `parameters`  | `?mixed`  | `null`  | JSON Schema defining the function's parameters.                        |
...
| `images`     | `?array<OcrImage>` | `null`  | Embedded images extracted from the page (if `include_image_base64` was true). |
...
| `meta`    | `?mixed`              | `null`  | Optional metadata about the reranking operation. |
