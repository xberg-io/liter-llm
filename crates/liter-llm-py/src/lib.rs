...
// alef:hash:357f4c4d0c7ab2711a49937a7abf932d29b6e9ffc5a2d9387954f6140bae55c5
...
impl SpecificToolChoice {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (r#type=Self::default().choice_type, function=Self::default().function))]
    #[new]
    pub fn new(r#type: ToolType, function: SpecificFunction) -> Self {
        Self {
            choice_type: r#type,
            function,
        }
...
impl Choice {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (index=Self::default().index, message=Self::default().message, finish_reason=None))]
    #[new]
...
impl StreamChoice {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (index=Self::default().index, delta=Self::default().delta, finish_reason=None))]
    #[new]
...
impl AuthConfig {
    #[must_use]
    #[pyo3(signature = (auth_type, env_var=None))]
    #[new]
    pub fn new(auth_type: AuthType, env_var: Option<String>) -> Self {
        Self { auth_type, env_var }
    }
