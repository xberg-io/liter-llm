...
#[pyfunction]
#[pyo3(signature = ())]
pub fn complex_provider_names() -> PyResult<Vec<String>> {
...
pub fn count_tokens(model: String, text: String) -> PyResult<usize> {
    liter_llm::count_tokens(&model, &text).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (model, req))]
pub fn count_request_tokens(model: String, req: ChatCompletionRequest) -> PyResult<usize> {
...
pub fn check_bound(context: String, current_len: usize, incoming: usize, limit: usize) -> PyResult<()> {
    liter_llm::util::bounds::check_bound(&context, current_len, incoming, limit)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
