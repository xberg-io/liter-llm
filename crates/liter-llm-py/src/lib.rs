...
// alef:hash:39ad9e421827294d1d7eae4a4b682ccc0030b94f013e0577f006acb09f26329d
...
pub struct CacheBackend {
    pub(crate) inner: liter_llm::tower::CacheBackend,
}
...
impl CacheBackend {
    ...
    fn new(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        ...
        let inner: liter_llm::tower::CacheBackend = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid CacheBackend: {e}")))?;
        Ok(Self { inner })
    }
...
impl<'de> serde::Deserialize<'de> for CacheBackend {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = liter_llm::tower::CacheBackend::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
