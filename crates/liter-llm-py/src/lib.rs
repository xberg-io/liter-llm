...
// alef:hash:2ab48f27c5e36030e3037ed6ce1ac85ef006cf21dbeb96dcac8172c758fad1d7
...
impl ProviderConfig {
    #[must_use]
    #[pyo3(signature = (name, display_name=None, base_url=None, endpoints=None, model_prefixes=None))]
    #[new]
    pub fn new(
        name: String,
...
pub fn _internal_bindings(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<TowerCachedResponse>()?;
    m.add_class::<RateLimitConfig>()?;
    m.add_class::<TowerLlmRequest>()?;
    m.add_class::<TowerLlmResponse>()?;
    m.add_class::<Message>()?;
