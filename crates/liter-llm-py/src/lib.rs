...
// alef:hash:3c5106dd3cd94b8afe119b11878080c1eb2905ed2193aa98eb8524a983cbd99a
...
impl BudgetConfig {
    #[must_use]
    #[pyo3(signature = (model_limits=None, enforcement=None, global_limit=None))]
    #[new]
    pub fn new(
        ...
        Self {
            global_limit,
            model_limits: model_limits.unwrap_or_default(),
...
impl CacheConfig {
    #[must_use]
    #[pyo3(signature = (max_entries=None, ttl=None, backend=None))]
    #[new]
    pub fn new(max_entries: Option<usize>, ttl: Option<u64>, backend: Option<CacheBackend>) -> Self {
        Self {
            max_entries: max_entries.unwrap_or(256),
            ttl,
