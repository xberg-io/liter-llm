...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordCacheHit(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let v = core_crate::tower::metrics::record_cache_hit(&system, &model, &operation);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordCacheMiss(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let v = core_crate::tower::metrics::record_cache_miss(&system, &model, &operation);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordCacheStale(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let v = core_crate::tower::metrics::record_cache_stale(&system, &model, &operation);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordCircuitTrip(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let v = core_crate::tower::metrics::record_circuit_trip(&system, &model);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordRetryAttempt(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let v = core_crate::tower::metrics::record_retry_attempt(&system, &model, &operation);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordCacheTierHit(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let tier = match jstring_to_string(env, tier) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let v = core_crate::tower::metrics::record_cache_tier_hit(&system, &model, &tier);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordCacheTierMiss(
    mut env: EnvUnowned,
    _class: JClass,
    system: JString,
    model: JString,
    ...
    let v = core_crate::tower::metrics::record_cache_tier_miss(&system, &model, &tier);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordBudgetSpend(
    mut env: EnvUnowned,
    _class: JClass,
    model: JString,
    provider: JString,
    ...
    let provider = match jstring_to_string(env, provider) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let tenant_id = match jstring_to_string(env, tenant_id) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let user_id = match jstring_to_string(env, user_id) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let api_key_id = match jstring_to_string(env, api_key_id) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let v = core_crate::tower::metrics::record_budget_spend(
        &model,
        &provider,
        if tenant_id.is_empty() { None } else { Some(&tenant_id) },
        if user_id.is_empty() { None } else { Some(&user_id) },
        if api_key_id.is_empty() { None } else { Some(&api_key_id) },
        cost_usd as f64,
    );
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordBudgetRejection(
    mut env: EnvUnowned,
    _class: JClass,
    model: JString,
    provider: JString,
    ...
    let dimension = match jstring_to_string(env, dimension) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let v = core_crate::tower::metrics::record_budget_rejection(&model, &provider, &dimension);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordRealtimeSessionDuration(
    mut env: EnvUnowned,
    _class: JClass,
    provider: JString,
    duration_secs: jni::sys::jdouble,
) {
    // SAFETY: env is a valid EnvUnowned passed by the JVM for this native call frame.
    let mut __jni_attach_guard = unsafe { jni::AttachGuard::from_unowned(env.as_raw()) };
    let env = __jni_attach_guard.borrow_env_mut();
    ...
    let v = core_crate::tower::metrics::record_realtime_session_duration(&provider, duration_secs as f64);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordRealtimeEvent(
    mut env: EnvUnowned,
    _class: JClass,
    provider: JString,
    direction: JString,
    ...
    let direction = match jstring_to_string(env, direction) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let event_type = match jstring_to_string(env, event_type) {
        Ok(s) => s,
        Err(e) => {
            throw_jni_error(env, &format!("{e}"));
            return ();
    ...
    let v = core_crate::tower::metrics::record_realtime_event(&provider, &direction, &event_type);
}
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeRecordRealtimeBytes(
    mut env: EnvUnowned,
    _class: JClass,
    provider: JString,
    direction: JString,
    ...
    let v = core_crate::tower::metrics::record_realtime_bytes(&provider, &direction, byte_count as u64);
}
#[unsafe(no_mangle)]
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_dev_kreuzberg_literllm_android_LiterLlmBridge_nativeDefaultClientRetrieve(
    mut env: EnvUnowned,
    _class: JClass,
    handle: jlong,
    request_json: JString,
    ...
    let Some(result) = run_or_throw(
        env,
        std::panic::AssertUnwindSafe(|| runtime().block_on(client.retrieve(&batch_id))),
    ) else {
        return std::ptr::null_mut();
    };
    match result {
