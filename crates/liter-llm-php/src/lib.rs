...
// alef:hash:2d036c5d11f04d9f0fe5e2d1d75f4b5023d94c53b4b7ca1df6810329bdf773d4
...
impl DefaultClient {
    ...
    pub fn retrieve_file_async(&self, fileId: String) -> PhpResult<FileObject> {
        WORKER_RUNTIME
    ...
    pub fn delete_file_async(&self, fileId: String) -> PhpResult<DeleteResponse> {
        WORKER_RUNTIME
    ...
    pub fn file_content_async(&self, fileId: String) -> PhpResult<Vec<u8>> {
        WORKER_RUNTIME
    ...
    pub fn retrieve_batch_async(&self, batchId: String) -> PhpResult<BatchObject> {
        WORKER_RUNTIME
    ...
    pub fn cancel_batch_async(&self, batchId: String) -> PhpResult<BatchObject> {
        WORKER_RUNTIME
