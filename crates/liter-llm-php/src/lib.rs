...
pub struct BudgetConfig {
    ...
    #[serde(default = "crate::serde_defaults::budget_config_enforcement")]
    #[serde(skip_serializing_if = "String::is_empty")]
...
pub struct CacheConfig {
    ...
    #[serde(default = "crate::serde_defaults::cache_config_backend")]
...
mod serde_defaults {
    pub fn budget_config_enforcement() -> String {
        "Hard".to_string()
    }
    pub fn cache_config_max_entries() -> usize {
        256
    }
    pub fn cache_config_backend() -> String {
        "Memory".to_string()
    }
}
