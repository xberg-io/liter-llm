...
impl AssistantPart {
    ...
    pub fn _factory_text(text: String) -> Self {
        liter_llm::types::AssistantPart::Text { text: text }.into()
    }

    #[php(name = "refusal")]
    pub fn _factory_refusal(refusal: String) -> Self {
        liter_llm::types::AssistantPart::Refusal { refusal: refusal }.into()
    }
...
impl OcrDocument {
    ...
    pub fn _factory_url(url: String) -> Self {
        liter_llm::types::OcrDocument::Url { url: url }.into()
    }
...
impl CacheBackend {
    ...
    pub fn _factory_open_dal(scheme: String, config: HashMap<String, String>) -> Self {
        liter_llm::CacheBackend::OpenDal {
            scheme: scheme,
            config: config,
        }
        .into()
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("liter_llm", "1.10.1")
