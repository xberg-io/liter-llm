...
// alef:hash:7e6cd32d8ccf610f1f364a2112845e9b9186dcbf0e7bbbafbaef2bdb00064adb
...
#[derive(Clone)]
#[php_class]
#[php(name = "Liter\\Llm\\TowerLlmRequest")]
...
#[derive(Clone)]
#[php_class]
#[php(name = "Liter\\Llm\\TowerLlmResponse")]
...
impl LiterLlmApi {
    ...
    pub fn completion_cost(model: String, promptTokens: i64, completionTokens: i64) -> Option<f64> {
        liter_llm::cost::completion_cost(&model, promptTokens as u64, completionTokens as u64)
    }
    ...
    pub fn count_tokens(model: String, text: String) -> PhpResult<i64> {
        let result = liter_llm::tokenizer::count_tokens(&model, &text)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result as i64)
    }
    ...
    pub fn count_request_tokens(model: String, req: &ChatCompletionRequest) -> PhpResult<i64> {
        ...
        let result = liter_llm::tokenizer::count_request_tokens(&model, &req_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result as i64)
    }
...
pub fn get_module(module: ModuleBuilder) -> ModuleBuilder {
    module
        ...
        .class::<TowerLlmRequest>()
        .class::<TowerLlmResponse>()
        .class::<LiterLlmApi>()
        .class::<Message>()
        .class::<ContentPart>()
