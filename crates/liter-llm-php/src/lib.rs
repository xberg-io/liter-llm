...
impl DefaultClient {
     ...
     * @throws LiterLlmException Returns `BatchWaitError.Failed` if the batch reaches a failure terminal status.
...
impl FinishReason {
    ...
    pub const TOOLCALLS: &str = "ToolCalls";
    pub const CONTENTFILTER: &str = "ContentFilter";
    pub const FUNCTIONCALL: &str = "FunctionCall";
...
impl StreamFormat {
    ...
    pub const AWSEVENTSTREAM: &str = "AwsEventStream";
}
...
impl LiterLlmApi {
     ...
     * @throws LiterLlmException Returns an error if the custom-provider registry cannot be updated.
     */
...
impl From<ChatCompletionRequest> for liter_llm::types::ChatCompletionRequest {
    fn from(val: ChatCompletionRequest) -> Self {
        Self {
            ...
            modalities: val.modalities.map(|v| {
                v.into_iter()
                    .map(|s| match s.as_str() {
                        "text" => liter_llm::types::Modality::Text,
                        "audio" => liter_llm::types::Modality::Audio,
                        "image" => liter_llm::types::Modality::Image,
                        _ => liter_llm::types::Modality::Text,
                    })
                    .collect()
            }),
...
impl From<AssistantPart> for liter_llm::types::AssistantPart {
    fn from(val: AssistantPart) -> Self {
        match val.type_tag.as_str() {
            ...
            _ => liter_llm::types::AssistantPart::default(),
        }
    }
}
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("liter_llm", "1.7.0")
