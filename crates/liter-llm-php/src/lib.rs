...
// alef:hash:433ab4b4e455b33bd0a679d46ba9dac3db7ccbb628b7f0dbc02b8efa91eafe4e
...
impl EmbeddingResponse {
    ...
    #[php(constructor)]
    pub fn new(object: String, data: Vec<EmbeddingObject>, model: String) -> Self {
        Self {
            object,
            data,
            model,
...
impl ImagesResponse {
    ...
    #[php(constructor)]
    pub fn new(created: i64, data: Vec<Image>) -> Self {
        Self { created, data }
    }
...
impl RerankResponse {
    ...
    #[php(constructor)]
    pub fn new(id: Option<String>, results: Vec<RerankResult>) -> Self {
        Self {
            id,
            results,
...
impl OcrResponse {
    ...
    #[php(constructor)]
    pub fn new(pages: Vec<OcrPage>, model: String) -> Self {
        Self {
            pages,
            model,
            usage: Default::default(),
...
impl OcrPage {
    ...
    #[php(constructor)]
    pub fn new(index: u32, markdown: String, images: Option<Vec<OcrImage>>) -> Self {
        Self {
            index,
            markdown,
            images,
...
impl FileListResponse {
    ...
    #[php(constructor)]
    pub fn new(object: String, data: Vec<FileObject>, hasMore: Option<bool>) -> Self {
        Self {
            object,
            data,
            has_more: hasMore,
...
impl CustomProviderConfig {
    #[php(constructor)]
    pub fn new(name: String, base_url: String, auth_header: String, model_prefixes: Vec<String>) -> Self {
        Self {
            name,
            base_url,
            auth_header,
