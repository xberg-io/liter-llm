...
// alef:hash:1f38d255b103feb807e6caae052bdf88b21f0e864c1cc794782448d4bb4a9851
...
#[php_function]
pub fn defaultclient_chat_stream_next(handle: i64) -> ext_php_rs::prelude::Result<Option<String>> {
...
#[php_function]
pub fn defaultclient_chat_stream_free(handle: i64) -> ext_php_rs::prelude::Result<()> {
    if handle <= 0 {
        return Ok(());
    }
    let handle_ptr = handle as u64 as *mut DefaultClientChatStreamHandle;
