...
// alef:hash:a38c47510984e0221e0872499d00250b7aaa8cb6fbdb7bce39a128a3162b4463
...
export declare class TowerCachedResponse {
  /** Convert this cached response back into the full [`LlmResponse`] enum. */
  intoLlmResponse(): string;
}

export declare class TowerLlmRequest {
  /**
...
export declare class TowerLlmResponse {
  /**
