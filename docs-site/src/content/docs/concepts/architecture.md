...
crates/liter-llm/schemas/
  providers.json     # 163 runtime providers plus schema metadata and complex-provider names
```
...
See [Proxy Server](/server/proxy-server/) and [Proxy Configuration](/server/proxy-configuration/) for operational details.
