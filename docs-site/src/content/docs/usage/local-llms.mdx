...
import { Content as Snip_python_usage_local_llm } from "../../../snippets/python/usage/local_llm.md";
import { Content as Snip_typescript_usage_local_llm } from "../../../snippets/typescript/usage/local_llm.md";
import { Content as Snip_rust_usage_local_llm } from "../../../snippets/rust/usage/local_llm.md";
import { Content as Snip_go_usage_local_llm } from "../../../snippets/go/usage/local_llm.md";
...
All of these providers are registered in the [provider registry](/providers/). LocalAI and llama.cpp are also built in with the `localai/` and `llamacpp/` prefixes. For any other OpenAI-compatible server, use a [custom provider](/usage/configuration/#custom-providers) — register the prefix and base URL once, then route to it like any other provider.
...
<Snip_python_usage_local_llm />

</TabItem>
<TabItem label="TypeScript">

<Snip_typescript_usage_local_llm />

</TabItem>
<TabItem label="Rust">

<Snip_rust_usage_local_llm />

</TabItem>
<TabItem label="Go">

<Snip_go_usage_local_llm />
