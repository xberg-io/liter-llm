...
import { Content as Snip_python_guides_configuration } from "../../../snippets/python/guides/configuration.md";
import { Content as Snip_typescript_guides_configuration } from "../../../snippets/typescript/guides/configuration.md";
import { Content as Snip_rust_usage_configuration } from "../../../snippets/rust/usage/configuration.md";
import { Content as Snip_go_guides_configuration } from "../../../snippets/go/guides/configuration.md";
import { Content as Snip_java_usage_configuration } from "../../../snippets/java/usage/configuration.md";
import { Content as Snip_csharp_usage_configuration } from "../../../snippets/csharp/usage/configuration.md";
import { Content as Snip_ruby_usage_configuration } from "../../../snippets/ruby/usage/configuration.md";
import { Content as Snip_php_usage_configuration } from "../../../snippets/php/usage/configuration.md";
import { Content as Snip_elixir_usage_configuration } from "../../../snippets/elixir/usage/configuration.md";
import { Content as Snip_wasm_usage_configuration } from "../../../snippets/wasm/usage/configuration.md";
...
| `tracing`           | bool   | Emit `tracing` spans for each request (see [Observability](/usage/observability/)). |
...
<Snip_python_guides_configuration />

</TabItem>
<TabItem label="TypeScript">

<Snip_typescript_guides_configuration />

</TabItem>
<TabItem label="Rust">

<Snip_rust_usage_configuration />

</TabItem>
<TabItem label="Go">

<Snip_go_guides_configuration />

</TabItem>
<TabItem label="Java">

<Snip_java_usage_configuration />

</TabItem>
<TabItem label="C#">

<Snip_csharp_usage_configuration />

</TabItem>
<TabItem label="Ruby">

<Snip_ruby_usage_configuration />

</TabItem>
<TabItem label="PHP">

<Snip_php_usage_configuration />

</TabItem>
<TabItem label="Elixir">

<Snip_elixir_usage_configuration />

</TabItem>
<TabItem label="WASM">

<Snip_wasm_usage_configuration />
...
The tracing reference has moved to [Observability](/usage/observability/). That page covers span attributes, OTEL exporter setup, cost tracking, and Tower layer composition.
