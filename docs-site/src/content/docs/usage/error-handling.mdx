...
import { Content as Snip_python_guides_error_handling } from "../../../snippets/python/guides/error_handling.md";
import { Content as Snip_typescript_guides_error_handling } from "../../../snippets/typescript/guides/error_handling.md";
import { Content as Snip_rust_guides_error_handling } from "../../../snippets/rust/guides/error_handling.md";
import { Content as Snip_go_guides_error_handling } from "../../../snippets/go/guides/error_handling.md";
import { Content as Snip_java_guides_error_handling } from "../../../snippets/java/guides/error_handling.md";
import { Content as Snip_csharp_guides_error_handling } from "../../../snippets/csharp/guides/error_handling.md";
import { Content as Snip_ruby_guides_error_handling } from "../../../snippets/ruby/guides/error_handling.md";
import { Content as Snip_php_guides_error_handling } from "../../../snippets/php/guides/error_handling.md";
import { Content as Snip_elixir_guides_error_handling } from "../../../snippets/elixir/guides/error_handling.md";
import { Content as Snip_wasm_guides_error_handling } from "../../../snippets/wasm/guides/error_handling.md";
...
This page is the canonical reference. See [API Reference](/reference/api-python/) for the per-language exception names.
...
Transient variants trigger fallbacks and retries. The [Fallback & Routing](/usage/fallback-routing/) layer calls `LiterLlmError::is_transient()` to decide whether to try the next endpoint or return the error to the caller.
...
Retries apply to single-endpoint calls. Cross-endpoint failover between models is handled by the separate [Fallback & Routing](/usage/fallback-routing/) layer.
...
See the `Error Handling` section of each language reference for full class inheritance, retry helpers, and runnable examples: [Python](/reference/api-python/#errors), [TypeScript](/reference/api-typescript/#errors), [Rust](/reference/api-rust/#errors), [Go](/reference/api-go/#errors), [Java](/reference/api-java/#errors), [C#](/reference/api-csharp/#errors), [Ruby](/reference/api-ruby/#errors), [Elixir](/reference/api-elixir/#errors), [PHP](/reference/api-php/#errors), [WASM](/reference/api-wasm/#errors), [C FFI](/reference/api-c/#errors).
:::
...
<Snip_python_guides_error_handling />
...
<Snip_typescript_guides_error_handling />
...
<Snip_rust_guides_error_handling />
...
<Snip_java_guides_error_handling />
...
<Snip_csharp_guides_error_handling />
...
<Snip_ruby_guides_error_handling />
...
<Snip_php_guides_error_handling />
...
<Snip_elixir_guides_error_handling />
...
<Snip_wasm_guides_error_handling />

## Observability

The tracing middleware records an `error.type` span attribute on every failed request, set to the value returned by `LiterLlmError::error_type()`. The set of possible values matches the variant names in the table above. See [Observability](/usage/observability/) for the full span schema.
