...
## Swift API Reference <span class="version-badge">v1.10.1</span>
...
```swift
public func reasoningText() -> String?
```

**Example:**

```swift
let result = instance.reasoningText()
```
...
```swift
public static func default() -> CatalogRefreshConfig
```
