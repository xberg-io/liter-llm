...
## C# API Reference <span class="version-badge">v1.10.1</span>
...
```csharp
var result = await RefreshCatalog(new CatalogRefreshConfig());
```
...
```csharp
public CatalogRefreshConfig CreateDefault()
```

**Example:**

```csharp
var result = CatalogRefreshConfig.CreateDefault();
```
