...
<!-- alef:hash:72dff74fe4db8f6b31cac9deb735b795d25db8ed6a9bc50b034149a8b2bdf101 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Rust API Reference <span class="version-badge">v2.0.1</span>
...
```rust
pub fn set_outbound_policy(policy: String)
```

**Example:**

```rust
set_outbound_policy("value");
```
...
```rust
pub fn current_policy() -> String
```

**Example:**

```rust
let result = current_policy();
```
...
```rust
validate_outbound_url("value").await?;
```
...
```rust
validate_outbound_url_sync("value")?;
```
...
```rust
pub fn is_forbidden(ip: String) -> bool
```

**Example:**

```rust
let result = is_forbidden("value");
```
...
```rust
pub fn guarded_resolver() -> String
```

**Example:**

```rust
let result = guarded_resolver();
```
...
```rust
pub fn cached_guarded_resolver(cache_ttl: Option<std::time::Duration>) -> String
```

**Example:**

```rust
let result = cached_guarded_resolver(std::time::Duration::from_secs(1));
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cache_ttl` | `Option<std::time::Duration>` | No | The cache ttl |
...
```rust
pub fn model_pricing(model: &str) -> Option<String>
```

**Example:**

```rust
let result = model_pricing("value");
```
...
```rust
pub fn global_meter() -> Option<String>
```

**Example:**

```rust
let result = global_meter();
```
