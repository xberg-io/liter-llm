...
## Kotlin (Android) API Reference <span class="version-badge">v1.10.1</span>
...
```kotlin
val result = instance.reasoningText()
```
...
```kotlin
@JvmStatic
fun default(): CatalogRefreshConfig
```

**Example:**

```kotlin
val result = CatalogRefreshConfig.default()
```
